#include "constants/pokemon.h"
	...
	thumb_func_start PCBox_OvyInit
PCBox_OvyInit: ; 0x021E5900
	push {r3, r4, r5, lr}
	mov r2, #1
	add r5, r0, #0
	mov r0, #3
	...
	mov r0, #1
	pop {r3, r4, r5, pc}
	thumb_func_end PCBox_OvyInit

	thumb_func_start PCBox_OvyExec
PCBox_OvyExec: ; 0x021E596C
	push {r4, lr}
	add r4, r1, #0
...
_021E5982:
	...
	pop {r4, pc}
	.balign 4, 0
	thumb_func_end PCBox_OvyExec

	thumb_func_start PCBox_OvyExit
PCBox_OvyExit: ; 0x021E5988
	push {r4, lr}
	add r4, r0, #0
	bl OverlayManager_GetData
	add r1, r0, #0
...
_021E8A06:
	...
	mov r2, #9
	str r0, [r4, #0x30]
	ldr r0, _021E8A78 ; =gOvyTemplate_PokemonSummary
...
_021E8A78: .word gOvyTemplate_PokemonSummary
...
ov14_021F2A60: ; 0x021F2A60
	...
	lsl r0, r0, #2
	ldr r0, [r1, r0]
	ldr r3, _021F2A70 ; =UnkImageStruct_SetSpritePriority
	add r1, r2, #0
	bx r3
	.balign 4, 0
_021F2A70: .word UnkImageStruct_SetSpritePriority
...
ov14_021F395C: ; 0x021F395C
	...
	lsl r3, r3, #2
	ldr r0, [r0, r3]
	ldr r3, _021F3968 ; =UnkImageStruct_SetSpritePositionXY
	bx r3
	nop
_021F3968: .word UnkImageStruct_SetSpritePositionXY
...
ov14_021F4940: ; 0x021F4940
	...
	add r1, r2, #0
	add r2, r3, #0
	ldr r3, _021F4954 ; =UnkImageStruct_GetSpritePositionXY
	bx r3
	nop
_021F4954: .word UnkImageStruct_GetSpritePositionXY
