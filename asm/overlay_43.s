	...
	thumb_func_start PalPad_OvyInit
PalPad_OvyInit: ; 0x02229EE0
	push {r3, r4, r5, lr}
	add r5, r0, #0
...
_02229FB0: .word ov43_0222A148
	thumb_func_end PalPad_OvyInit

	thumb_func_start PalPad_OvyExec
PalPad_OvyExec: ; 0x02229FB4
	push {r3, r4, r5, r6, lr}
	sub sp, #4
	add r5, r1, #0
...
_0222A0A8: .word 0x0000021D
	thumb_func_end PalPad_OvyExec

	thumb_func_start PalPad_OvyExit
PalPad_OvyExit: ; 0x0222A0AC
	push {r3, r4, r5, lr}
	add r5, r0, #0
	bl OverlayManager_GetData
	add r4, r0, #0
