...
_021E6428:
	...
	thumb_func_start Phone_OvyInit
Phone_OvyInit: ; 0x021E642C
	push {r3, r4, r5, lr}
	add r4, r0, #0
...
_021E651C: .word 0x0000FFFF
	thumb_func_end Phone_OvyInit

	thumb_func_start Phone_OvyExec
Phone_OvyExec: ; 0x021E6520
	push {r4, lr}
	add r4, r1, #0
...
_021E65B8:
	mov r0, #0
	pop {r4, pc}
	thumb_func_end Phone_OvyExec

	thumb_func_start Phone_OvyExit
Phone_OvyExit: ; 0x021E65BC
	push {r3, r4, r5, lr}
	add r5, r0, #0
	bl OverlayManager_GetData
	add r4, r0, #0
