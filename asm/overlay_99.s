	...
	thumb_func_start PokeathlonCourseRecord_OvyInit
PokeathlonCourseRecord_OvyInit: ; 0x021E5900
	push {r4, r5, lr}
	sub sp, #0x1c
	add r4, r0, #0
...
_021E5A00: .word ov99_021E6250
	thumb_func_end PokeathlonCourseRecord_OvyInit

	thumb_func_start PokeathlonCourseRecord_OvyExit
PokeathlonCourseRecord_OvyExit: ; 0x021E5A04
	push {r3, r4, r5, lr}
	add r5, r0, #0
...
_021E5A34: .word FS_OVERLAY_ID(OVY_98)
	thumb_func_end PokeathlonCourseRecord_OvyExit

	thumb_func_start PokeathlonCourseRecord_OvyExec
PokeathlonCourseRecord_OvyExec: ; 0x021E5A38
	push {r4, r5, lr}
	sub sp, #0xc
	add r5, r1, #0
	bl OverlayManager_GetData
...
_021E5B50: .word _021EA5C0
	thumb_func_end PokeathlonCourseRecord_OvyExec
...
_021E7814: .word 0x00000444
	...
	thumb_func_start PokeathlonMedals_OvyInit
PokeathlonMedals_OvyInit: ; 0x021E7818
	push {r3, r4, r5, lr}
	add r4, r0, #0
...
_021E78EC: .word ov99_021E7A54
	thumb_func_end PokeathlonMedals_OvyInit

	thumb_func_start PokeathlonMedals_OvyExit
PokeathlonMedals_OvyExit: ; 0x021E78F0
	push {r3, r4, r5, lr}
	add r5, r0, #0
	bl OverlayManager_GetData
	add r4, r0, #0
...
_021E7948: .word FS_OVERLAY_ID(OVY_98)
	thumb_func_end PokeathlonMedals_OvyExit

	thumb_func_start PokeathlonMedals_OvyExec
PokeathlonMedals_OvyExec: ; 0x021E794C
	push {r4, r5, lr}
	sub sp, #0xc
	add r5, r1, #0
	bl OverlayManager_GetData
...
_021E7A50: .word 0x00000404
	thumb_func_end PokeathlonMedals_OvyExec
...
_021E82FA:
	...
	thumb_func_start PokeathlonEventRecord_OvyInit
PokeathlonEventRecord_OvyInit: ; 0x021E8304
	push {r3, r4, r5, lr}
	add r4, r0, #0
...
_021E83A8: .word ov99_021E856C
	thumb_func_end PokeathlonEventRecord_OvyInit

	thumb_func_start PokeathlonEventRecord_OvyExit
PokeathlonEventRecord_OvyExit: ; 0x021E83AC
	push {r3, r4, r5, lr}
	add r5, r0, #0
	bl OverlayManager_GetData
	add r4, r0, #0
...
_021E83F0: .word FS_OVERLAY_ID(OVY_98)
	thumb_func_end PokeathlonEventRecord_OvyExit

	thumb_func_start PokeathlonEventRecord_OvyExec
PokeathlonEventRecord_OvyExec: ; 0x021E83F4
	push {r4, r5, lr}
	sub sp, #0xc
	add r5, r1, #0
	bl OverlayManager_GetData
...
_021E84E8: .word _021EA5E4
	thumb_func_end PokeathlonEventRecord_OvyExec
