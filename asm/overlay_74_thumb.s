...
_022331DE:
	...
	pop {r3, r4, r5, pc}
_022331FC:
	ldr r0, _02233228 ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	cmp r0, #0
	bne _0223320C
	ldr r0, _0223322C ; =gMain
	ldr r0, [r0, #0x48]
	cmp r0, #0
	beq _0223321C
_0223320C:
...
_022334BC:
	...
	b _02233896
_022334CE:
	ldr r0, _02233634 ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	cmp r0, #0
	bne _022334DE
	ldr r0, _02233638 ; =gMain
	ldr r0, [r0, #0x48]
	cmp r0, #0
	beq _0223350E
_022334DE:
...
_02233634: .word gMain + 0x40
_02233638: .word gMain
...
_0223383C:
	...
	b _02233896
_0223385A:
	ldr r0, _022338CC ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	cmp r0, #0
	bne _0223386A
	ldr r0, _022338D0 ; =gMain
	ldr r0, [r0, #0x48]
	cmp r0, #0
	beq _02233896
_0223386A:
...
_0223BBC0:
	...
	.byte 0x00, 0x02, 0x01, 0x03, 0x04, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
#ifdef HEARTGOLD
