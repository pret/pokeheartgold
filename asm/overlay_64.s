	...
	thumb_func_start HallOfFameCongrats_OvyInit
HallOfFameCongrats_OvyInit: ; 0x021E5900
	push {r3, r4, r5, lr}
	add r5, r0, #0
	mov r0, #0
	add r1, r0, #0
...
_021E59C4: .word ov64_021E5A88
	thumb_func_end HallOfFameCongrats_OvyInit

	thumb_func_start HallOfFameCongrats_OvyExit
HallOfFameCongrats_OvyExit: ; 0x021E59C8
	push {r3, r4, r5, lr}
	add r5, r0, #0
	...
	pop {r3, r4, r5, pc}
	.balign 4, 0
	thumb_func_end HallOfFameCongrats_OvyExit

	thumb_func_start HallOfFameCongrats_OvyExec
HallOfFameCongrats_OvyExec: ; 0x021E5A18
	push {r3, r4, r5, lr}
	add r4, r1, #0
	bl OverlayManager_GetData
	ldr r1, [r4]
...
_021E5A74:
	...
	mov r0, #0
	pop {r3, r4, r5, pc}
	thumb_func_end HallOfFameCongrats_OvyExec
