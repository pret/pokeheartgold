...
ov83_022478D4: ; 0x022478D4
	...
	mov r4, #0
	str r0, [sp, #4]
	ldr r0, _02247918 ; =ov83_022481A0
	ldr r7, [r0, r1]
	cmp r7, #0
	bls _02247910
_022478EE:
...
ov83_0224791C: ; 0x0224791C
	push {r4, r5, r6, lr}
	add r6, r0, #0
	ldr r0, _02247940 ; =ov83_022481A0
	lsl r1, r1, #3
	ldr r5, [r0, r1]
	mov r4, #0
	cmp r5, #0
...
ov83_0224819C: ; 0x0224819C
	.byte 0xC4, 0x82, 0x24, 0x02

ov83_022481A0: ; 0x022481A0
