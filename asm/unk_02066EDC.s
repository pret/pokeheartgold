...
_02066F64:
	...
	cmp r2, #6
	blo _02066F64
	ldr r1, _02066F8C ; =gOvyTemplate_PartyMenu
	add r0, r6, #0
	add r2, r4, #0
	...
	nop
_02066F8C: .word gOvyTemplate_PartyMenu
...
sub_02066FEC: ; 0x02066FEC
	...
	add r0, r4, #0
	bl sub_0208AD34
	ldr r1, _02067084 ; =gOvyTemplate_PokemonSummary
	add r0, r7, #0
	add r2, r4, #0
	bl FieldSystem_LaunchApplication
	ldr r0, [r6, #0x14]
...
_02067084: .word gOvyTemplate_PokemonSummary
...
sub_02067164: ; 0x02067164
	...
	ldrh r2, [r4, #0x14]
	add r0, r5, #0
	bl LaunchNintendoWifiConnectionApp
	str r0, [r4, #8]
	mov r0, #1
	pop {r3, r4, r5, pc}
_02067184:
