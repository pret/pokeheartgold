...
_022305CA:
	...
	lsl r2, r2, #0x11
	lsr r2, r2, #0x11
	bl _3DGfxResMan_AllocObj
	str r0, [sp, #0x1c]
	cmp r6, #1
	bne _02230608
	bl _3DGfxResObj_AllocVramAndGetKeys
	ldr r0, [sp, #0x1c]
	bl _3DGfxResObj_LoadTex
	ldr r0, [sp, #0x1c]
	bl _3DGfxResObj_FreeVramAndSecondaryHeader
_02230608:
	add r7, r7, #1
	add r5, r5, #4
	cmp r7, #0x14
...
ov45_02230638: ; 0x02230638
	...
	bl ov45_02230A44
	ldr r0, [r4, #8]
	bl _3DGfxResMan_FreeAllObjs
	ldr r0, [r4]
	bl _2DGfxResMan_FreeAllObjs
	ldr r0, [r4, #4]
	bl _2DGfxResMan_FreeAllObjs
	ldr r0, [r4, #0xc]
	bl sub_02023874
...
ov45_0223070C: ; 0x0223070C
	...
	ldr r0, [r5]
	mov r1, #0x7f
	bl _2DGfxResMan_GetObjById
	bl _2DGfxResObj_GetData
	ldrh r1, [r6, #2]
	str r0, [sp, #0x14]
	ldr r0, [r5, #8]
	lsl r1, r1, #0x11
