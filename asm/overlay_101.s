...
_021E8758:
	...
	pop {r3, r4, r5, pc}
	nop
_021E8768: .word 0x021F7C04
_021E876C: .word 0x021F7BA4
_021E8770: .word 0x021F7B30
...
_021E8A12:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021E8A74: .word 0x021F7DB8
_021E8A78: .word 0x021F7DE0
_021E8A7C: .word 0x021F7E08
_021E8A80: .word 0x021F7E30
_021E8A84: .word 0x021F7E58
...
_021E8DC2:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.align 2, 0
_021E8E00: .word 0x021F7C70
_021E8E04: .word 0x021F7C98
_021E8E08: .word 0x000001E2
_021E8E0C: .word 0x021F7CC0
_021E8E10: .word 0x00000326
_021E8E14: .word 0x021F7CE8
...
ov101_021E8E3C: ; 0x021E8E3C
	ldr r3, _021E8E48 ; =sub_021E6F34
	add r0, #0x84
	ldr r0, [r0]
	mov r1, #0xb
	bx r3
	nop
_021E8E48: .word sub_021E6F34
	thumb_func_end ov101_021E8E3C

	thumb_func_start ov101_021E8E4C
ov101_021E8E4C: ; 0x021E8E4C
	ldr r3, _021E8E54 ; =sub_021E6EF4
	add r0, #0x84
	ldr r0, [r0]
	bx r3
	.align 2, 0
_021E8E54: .word sub_021E6EF4
...
ov101_021EB364: ; 0x021EB364
	ldr r0, [r0, #0x10]
	ldr r3, _021EB370 ; =sub_021E7128
	ldr r0, [r0, #0x7c]
	ldr r1, _021EB374 ; =0x0000FFFF
	mov r2, #0
	bx r3
	.align 2, 0
_021EB370: .word sub_021E7128
...
ov101_021EB378: ; 0x021EB378
	ldr r0, [r0, #0x10]
	ldr r3, _021EB384 ; =sub_021E7128
	ldr r0, [r0, #0x7c]
	ldr r1, _021EB388 ; =0x0000FFFF
	mov r2, #1
	bx r3
	.align 2, 0
_021EB384: .word sub_021E7128
...
_021EBBFC: .word 0x021F7EAC
_021EBC00: .word 0x00000941
_021EBC04: .word 0x00000943
_021EBC08: .word 0x00000949
_021EBC0C: .word 0x021F7EA4
_021EBC10: .word 0x021D114C
...
_021EBDD4: .word 0x021F7E94
_021EBDD8: .word 0x021F7EA8
_021EBDDC: .word 0x021D114C
...
_021EC490: .word 0x021F7E8E
_021EC494: .word 0x021F7E8C
...
_021ECA1C:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021ECA28: .word 0x021F7E9C
_021ECA2C: .word 0x021D114C
...
_021ECE48: .word 0x021F7EF4
_021ECE4C: .word 0x00000947
_021ECE50: .word 0x021D114C
...
_021ED0C8:
	...
	pop {r3, r4, r5, pc}
	nop
_021ED100: .word 0x021D114C
_021ED104: .word 0x021F7EB8
...
_021ED478:
	...
	pop {r4, r5, r6, pc}
	nop
_021ED480: .word 0x021D114C
_021ED484: .word 0x021F7ECC
_021ED488: .word 0x00000139
_021ED48C: .word 0x00000946
_021ED490: .word 0x00000948
_021ED494: .word 0x021F7EEC
...
_021EDF4C: .word 0x021F7F44
_021EDF50: .word 0x021F7F9C
...
_021EE5EC:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.align 2, 0
_021EE64C: .word 0x021F807C
_021EE650: .word 0x021F80A4
_021EE654: .word 0x021F80CC
_021EE658: .word 0x021F80F4
_021EE65C: .word 0x021F811C
_021EE660: .word 0x021F81E4
	thumb_func_end ov101_021EE410

	thumb_func_start ov101_021EE664
ov101_021EE664: ; 0x021EE664
	ldr r3, _021EE66C ; =sub_021E6EF4
	add r0, #0x84
	ldr r0, [r0]
	bx r3
	.align 2, 0
_021EE66C: .word sub_021E6EF4
...
ov101_021EF260: ; 0x021EF260
	ldr r3, _021EF268 ; =sub_0201AB0C
	ldr r0, [r0, #0x44]
	bx r3
	nop
_021EF268: .word sub_0201AB0C
...
ov101_021EF50C: ; 0x021EF50C
	...
	pop {r4, r5, r6, pc}
	.align 2, 0
_021EF590: .word 0x021F83C4
_021EF594: .word 0x021F83D0
_021EF598: .word 0x021F83D1
_021EF59C: .word 0x021F83D2
...
_021F07B4:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021F0858: .word 0x021F84E8
_021F085C: .word 0x021F85D8
_021F0860: .word 0x021F8600
...
_021F0A68:
	...
	pop {r4, r5, r6, pc}
	.align 2, 0
_021F0A74: .word 0x021F8628
_021F0A78: .word 0x000004E8
_021F0A7C: .word 0x021F8404
_021F0A80: .word 0x021F8407
_021F0A84: .word 0x021F8406
...
_021F242A:
	...
	pop {r4, pc}
	nop
_021F2430: .word 0x021D110C
_021F2434: .word 0x000005DC
_021F2438: .word 0x021F8400
...
_021F2B58:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.align 2, 0
_021F2B70: .word 0x021F86BC
_021F2B74: .word 0x021F86BD
...
_021F312C:
	...
	pop {r4, r5, r6, pc}
	.align 2, 0
_021F3134: .word 0x00000988
_021F3138: .word 0x00000987
...
_021F3418:
	...
	pop {r4, r5, r6, r7, pc}
	.align 2, 0
_021F3424: .word 0x00000987
_021F3428: .word 0x00000988
...
_021F4624:
	...
	bx lr
	nop
_021F462C: .word 0x021F87AC
_021F4630: .word 0x021FB2C0
...
ov101_021F4E6C: ; 0x021F4E6C
	ldr r3, _021F4E74 ; =sub_021E6978
	ldr r0, [r0, #0xc]
	mov r1, #1
	bx r3
	.align 2, 0
_021F4E74: .word sub_021E6978
	thumb_func_end ov101_021F4E6C

	thumb_func_start ov101_021F4E78
ov101_021F4E78: ; 0x021F4E78
	ldr r3, _021F4E80 ; =sub_021E69C8
	ldr r0, [r0, #0xc]
	bx r3
	nop
_021F4E80: .word sub_021E69C8
...
_021F4FB6:
	...
	pop {r3, r4, r5, r6, pc}
	.align 2, 0
_021F4FC4: .word 0x021FB2C8
_021F4FC8: .word 0x021FB2C9
...
_021F5434:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_021F545C: .word 0x021D110C
_021F5460: .word 0x0000093F
_021F5464: .word 0x021F8968
...
_021F5636:
	...
	pop {r3, r4, r5, r6, pc}
	nop
_021F5640: .word 0x021F8984
_021F5644: .word 0x0000093F
_021F5648: .word 0x021D114C
_021F564C: .word 0x021F8968
...
_021F56A6:
	...
	pop {r4, pc}
	.align 2, 0
_021F56AC: .word 0x021D114C
_021F56B0: .word 0x021F8968
...
ov101_021F5780: ; 0x021F5780
	...
	pop {r4, pc}
	.align 2, 0
_021F57B0: .word 0x021F89B5
_021F57B4: .word 0x021F89B6
...
_021F5C38:
	pop {r4, pc}
	nop
_021F5C3C: .word 0x021F8A08
_021F5C40: .word 0x021F8A0C
...
ov101_021F613C: ; 0x021F613C
	ldr r3, _021F6144 ; =sub_0200BB44
	ldr r0, [r0, #0x24]
	bx r3
	nop
_021F6144: .word sub_0200BB44
...
ov101_021F61CC: ; 0x021F61CC
	ldr r3, _021F61D4 ; =sub_0200BB44
	ldr r0, [r0, #0x24]
	bx r3
	nop
_021F61D4: .word sub_0200BB44
...
ov101_021F625C: ; 0x021F625C
	ldr r3, _021F6264 ; =sub_0200BB44
	ldr r0, [r0, #0x24]
	bx r3
	nop
_021F6264: .word sub_0200BB44
...
ov101_021F6320: ; 0x021F6320
	ldr r3, _021F6328 ; =sub_0200BB44
	ldr r0, [r0, #0x24]
	bx r3
	nop
_021F6328: .word sub_0200BB44
...
ov101_021F6470: ; 0x021F6470
	ldr r3, _021F6478 ; =sub_0200BB44
	ldr r0, [r0, #0x24]
	bx r3
	nop
_021F6478: .word sub_0200BB44
...
ov101_021F699C: ; 0x021F699C
	ldr r3, _021F69A4 ; =sub_0200BB44
	ldr r0, [r0, #0x24]
	bx r3
	nop
_021F69A4: .word sub_0200BB44
...
ov101_021F6D0C: ; 0x021F6D0C
	ldr r3, _021F6D14 ; =sub_0200BB44
	ldr r0, [r0, #0x24]
	bx r3
	nop
_021F6D14: .word sub_0200BB44
...
ov101_021F6FC0: ; 0x021F6FC0
	ldr r3, _021F6FC8 ; =sub_0200BB44
	ldr r0, [r0, #0x24]
	bx r3
	nop
_021F6FC8: .word sub_0200BB44
...
ov101_021F734C: ; 0x021F734C
	ldr r3, _021F7354 ; =sub_0200BB44
	ldr r0, [r0, #0x24]
	bx r3
	nop
_021F7354: .word sub_0200BB44
