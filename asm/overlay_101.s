...
_021ED7E4:
	...
	thumb_func_start TownMap_OvyInit
TownMap_OvyInit: ; 0x021ED7F8
	push {r3, r4, r5, lr}
	add r4, r0, #0
	bl OverlayManager_GetArgs
	add r5, r0, #0
...
_021ED8B0: .word ov101_021F7372
	thumb_func_end TownMap_OvyInit

	thumb_func_start TownMap_OvyExec
TownMap_OvyExec: ; 0x021ED8B4
	push {r4, lr}
	add r4, r1, #0
	bl OverlayManager_GetData
	ldr r1, [r4]
...
_021ED91E:
	...
	pop {r4, pc}
	.balign 4, 0
	thumb_func_end TownMap_OvyExec

	thumb_func_start TownMap_OvyExit
TownMap_OvyExit: ; 0x021ED924
	push {r3, r4, r5, lr}
	add r5, r0, #0
	bl OverlayManager_GetData
	add r4, r0, #0
...
_021ED97C: .word FS_OVERLAY_ID(OVY_100)
	thumb_func_end TownMap_OvyExit
