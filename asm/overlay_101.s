...
PhoneCall_GetCallScriptId_Mother: ; 0x021F27E4
	...
	mov r0, #4
	strh r0, [r4, #0x20]
	mov r0, #0  // Bank call, results in: Hello?\r...{STRVAR_1 3, 0, 0}?\rI heard from Professor Elm that you\nwent on a long trip.\rI wish you would have told me...\nWhat about your money? Should I\fsave it?
	pop {r3, r4, r5, pc}
_021F2804:
	ldr r1, [r4, #0x10]
	ldrh r2, [r1, #6]
...
ov101_021F8B60: ; 0x021F8B60
	.short 0x01C1, 0x0201, 0x01E7, 0x013B, 0x01EA, 0x01EB, 0x01EC, 0x00ED
	.short 0x00EE, 0x00EF, 0x00F2, 0x00F3, 0x012A, 0x0165
