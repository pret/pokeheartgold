...
_021D1108:
	...
	thumb_func_start CreateCameraTranslationWrapper
CreateCameraTranslationWrapper: ; 0x02019014
	push {r3, r4, r5, lr}
	add r5, r1, #0
	mov r1, #0x34
	bl AllocFromHeap
	...
	pop {r3, r4, r5, pc}
	.balign 4, 0
	thumb_func_end CreateCameraTranslationWrapper

	thumb_func_start DeleteCameraTranslationWrapper
DeleteCameraTranslationWrapper: ; 0x02019030
	push {r4, lr}
	add r4, r0, #0
	bl sub_0201915C
	add r0, r4, #0
	bl FreeToHeap
	pop {r4, pc}
	thumb_func_end DeleteCameraTranslationWrapper

	thumb_func_start SetCameraTranslationPath
SetCameraTranslationPath: ; 0x02019040
	push {r4, r5, r6, lr}
	sub sp, #0x28
	add r5, r0, #0
	ldrb r0, [r5, #7]
...
_020190E4: .word sub_020190FC
	thumb_func_end SetCameraTranslationPath

	thumb_func_start IsCameraTranslationFinished
IsCameraTranslationFinished: ; 0x020190E8
	ldrb r0, [r0, #7]
	cmp r0, #0
	bne _020190F2
	mov r0, #1
...
_020190F4:
	...
	bx lr
	.balign 4, 0
	thumb_func_end IsCameraTranslationFinished
