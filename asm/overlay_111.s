	...
	thumb_func_start BugContestSwapMon_OvyInit
BugContestSwapMon_OvyInit: ; 0x021E5900
	push {r3, r4, lr}
	sub sp, #0xc
	add r4, r1, #0
	ldr r1, [r4]
...
_021E595A:
	...
	add sp, #0xc
	pop {r3, r4, pc}
	thumb_func_end BugContestSwapMon_OvyInit

	thumb_func_start BugContestSwapMon_OvyExit
BugContestSwapMon_OvyExit: ; 0x021E5960
	push {r4, r5, lr}
	sub sp, #0xc
	add r4, r1, #0
	add r5, r0, #0
...
_021E59B0:
	...
	pop {r4, r5, pc}
	.balign 4, 0
	thumb_func_end BugContestSwapMon_OvyExit

	thumb_func_start BugContestSwapMon_OvyExec
BugContestSwapMon_OvyExec: ; 0x021E59B8
	push {r4, lr}
	bl OverlayManager_GetData
	add r4, r0, #0
	bne _021E59C6
...
_021E59E0: .word _021E6D40
	thumb_func_end BugContestSwapMon_OvyExec
