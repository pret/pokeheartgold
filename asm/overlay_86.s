...
ov86_021E7DF8: ; 0x021E7DF8
	...
	mov r4, #0
	str r0, [sp, #4]
	ldr r0, _021E7E3C ; =ov86_021E8234
	ldr r7, [r0, r1]
	cmp r7, #0
	bls _021E7E34
_021E7E12:
...
ov86_021E7E40: ; 0x021E7E40
	push {r4, r5, r6, lr}
	add r6, r0, #0
	ldr r0, _021E7E64 ; =ov86_021E8234
	lsl r1, r1, #3
	ldr r5, [r0, r1]
	mov r4, #0
	cmp r5, #0
...
ov86_021E7EA8: ; 0x021E7EA8
	.byte 0xE9, 0x73, 0x1E, 0x02, 0xE9, 0x73, 0x1E, 0x02
	.byte 0xA9, 0x78, 0x1E, 0x02, 0xB1, 0x78, 0x1E, 0x02

ov86_021E7EB8: ; 0x021E7EB8
	.byte 0xE9, 0x73, 0x1E, 0x02, 0xE9, 0x73, 0x1E, 0x02
	.byte 0x79, 0x76, 0x1E, 0x02, 0x81, 0x76, 0x1E, 0x02
...
ov86_021E8230: ; 0x021E8230
	.byte 0x58, 0x82, 0x1E, 0x02

ov86_021E8234: ; 0x021E8234
	.byte 0x07, 0x00, 0x00, 0x00, 0xD8, 0x82, 0x1E, 0x02, 0x18, 0x00, 0x00, 0x00
