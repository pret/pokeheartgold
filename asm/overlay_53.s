...
ov53_021E6908: ; 0x021E6908
	lsl r2, r1, #4
	ldr r1, _021E6924 ; =ov53_021E86B4
	mov r3, #0
	strb r3, [r0, #3]
	ldr r1, [r1, r2]
	strb r3, [r0]
...
ov53_021E6928: ; 0x021E6928
	push {r3, r4, r5, lr}
	sub sp, #0x10
	ldr r3, _021E6980 ; =ov53_021E86B4
	mov r2, #0x16
	lsl r1, r1, #4
	add r4, r0, #0
	mov r0, #0
...
_021E6F2C:
	mov r3, #6
	mul r3, r2
	ldr r2, _021E6F90 ; =ov53_021E8540
	add r5, r0, #2
	ldrsh r2, [r2, r3]
	ldrsh r5, [r4, r5]
	add r6, r5, r2
	...
	cmp r2, #0
	ble _021E6F58
	ldr r2, _021E6F94 ; =ov53_021E853E
	ldrsh r3, [r2, r3]
	add r2, r5, #0
	ldrsh r2, [r4, r2]
	cmp r2, r3
...
_021E6F90: .word ov53_021E8540
_021E6F94: .word ov53_021E853E
...
_021E83BA:
	...
	lsl r3, r4, #2
	ldr r2, _021E83D0 ; =ov53_021E8876
	ldrsh r1, [r1, r3]
	ldrsh r2, [r2, r3]
	ldr r0, [r5, #0x10]
	bl sub_0200DD88
...
ov53_021E853E: ; 0x021E853E
	.byte 0xCC, 0xFF

ov53_021E8540: ; 0x021E8540
	.byte 0xFE, 0xFF, 0xCC, 0xFF, 0x00, 0x00, 0x02, 0x00
...
ov53_021E8784: ; 0x021E8784
	.byte 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x32, 0x00, 0x00, 0x00, 0x00, 0x00
