...
_0203D066:
	...
	strh r0, [r5, #0x28]
	ldr r0, [sp, #8]
	ldr r1, _0203D19C ; =gOvyTemplate_PartyMenu
	add r2, r5, #0
...
_0203D190:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.balign 4, 0
_0203D19C: .word gOvyTemplate_PartyMenu
...
_0203D604:
	...
	str r0, [r5, #0x20]
	ldr r0, [sp]
	ldr r1, _0203D65C ; =gOvyTemplate_PartyMenu
	add r2, r5, #0
	bl FieldSystem_LaunchApplication
	mov r0, #0xe1
	lsl r0, r0, #2
...
_0203D650:
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_0203D65C: .word gOvyTemplate_PartyMenu
...
sub_0203D940: ; 0x0203D940
	...
	ldr r0, [r5, r0]
	bl sub_02090F90
	ldr r1, _0203D9AC ; =gOvyTemplate_PartyMenu
	add r0, r7, #0
	add r2, r4, #0
	bl FieldSystem_LaunchApplication
	mov r0, #0xe
	...
	pop {r3, r4, r5, r6, r7, pc}
	.balign 4, 0
_0203D9AC: .word gOvyTemplate_PartyMenu
