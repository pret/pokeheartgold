...
_0202B04A:
	...
	thumb_func_start sub_0202B060
sub_0202B060: ; 0x0202B060
	push {r3, r4, r5, lr}
	add r4, r0, #0
	mov r0, #0
	str r0, [r4]
	strb r0, [r4, #4]
	ldr r0, _0202B0AC ; =0x020F5670
	mov r1, #8
	ldrb r0, [r0]
	strb r0, [r4, #5]
	ldr r0, _0202B0B0 ; =0x020F566C
	ldrb r0, [r0]
	strb r0, [r4, #6]
	mov r0, #0xff
	strb r0, [r4, #7]
...
_0202B09A:
	...
	pop {r3, r4, r5, pc}
	nop
_0202B0AC: .word 0x020F5670
_0202B0B0: .word 0x020F566C
_0202B0B4: .word 0x0000FFFF
	thumb_func_end sub_0202B060

	thumb_func_start sub_0202B0B8
sub_0202B0B8: ; 0x0202B0B8
	ldrb r0, [r0, #7]
	cmp r0, #0xb
	bhi _0202B0C2
	mov r0, #1
...
_0202B0C2:
	...
	bx lr
	.balign 4, 0
	thumb_func_end sub_0202B0B8

	thumb_func_start sub_0202B0C8
sub_0202B0C8: ; 0x0202B0C8
	push {r4, lr}
	mov r1, #0x38
	...
	pop {r4, pc}
	.balign 4, 0
	thumb_func_end sub_0202B0C8

	thumb_func_start sub_0202B0DC
sub_0202B0DC: ; 0x0202B0DC
	ldr r3, _0202B0E4 ; =MIi_CpuCopy8
	mov r2, #0x38
	bx r3
	nop
_0202B0E4: .word MIi_CpuCopy8
	thumb_func_end sub_0202B0DC

	thumb_func_start sub_0202B0E8
sub_0202B0E8: ; 0x0202B0E8
	push {r4, r5, r6, lr}
	add r5, r0, #0
	add r4, r1, #0
	ldr r1, [r5]
...
_0202B168:
	...
	pop {r4, r5, r6, pc}
	.balign 4, 0
	thumb_func_end sub_0202B0E8

	thumb_func_start sub_0202B178
sub_0202B178: ; 0x0202B178
	push {r4, r5, r6, r7, lr}
	sub sp, #0x14
	str r0, [sp]
	add r5, r1, #0
...
_0202B2D0: .word 0x020F67A4
	thumb_func_end sub_0202B178

	thumb_func_start sub_0202B2D4
sub_0202B2D4: ; 0x0202B2D4
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #8
	add r5, r0, #0
	mov r0, #3
...
_0202B3E0: .word 0xFFFF0FFF
	thumb_func_end sub_0202B2D4

	thumb_func_start sub_0202B3E4
sub_0202B3E4: ; 0x0202B3E4
	ldr r0, [r0]
	bx lr
	thumb_func_end sub_0202B3E4

	thumb_func_start sub_0202B3E8
sub_0202B3E8: ; 0x0202B3E8
	add r0, #8
	bx lr
	thumb_func_end sub_0202B3E8

	thumb_func_start sub_0202B3EC
sub_0202B3EC: ; 0x0202B3EC
	ldrb r0, [r0, #4]
	bx lr
	thumb_func_end sub_0202B3EC

	thumb_func_start sub_0202B3F0
sub_0202B3F0: ; 0x0202B3F0
	ldrb r0, [r0, #7]
	bx lr
	thumb_func_end sub_0202B3F0

	thumb_func_start sub_0202B3F4
sub_0202B3F4: ; 0x0202B3F4
	cmp r1, #0xc
	bhs _0202B3FA
	strb r1, [r0, #7]
_0202B3FA:
	bx lr
	thumb_func_end sub_0202B3F4

	thumb_func_start sub_0202B3FC
sub_0202B3FC: ; 0x0202B3FC
	ldrb r0, [r0, #5]
	bx lr
	thumb_func_end sub_0202B3FC
...
_0202B42A:
	...
	orr r0, r2
	strh r0, [r3]
	ldr r0, _0202B4D4 ; =0x020F67A8
	ldr r2, _0202B4D8 ; =0x020F67AA
	ldrh r0, [r0, r1]
	ldrb r1, [r2, r1]
	mov r2, #0
	bl sub_02074364
...
_0202B4C0:
	...
	pop {r3, r4, r5, r6, pc}
	nop
_0202B4C8: .word 0x020F67A4
_0202B4CC: .word 0x020F67A6
_0202B4D0: .word 0xFFFFF000
_0202B4D4: .word 0x020F67A8
_0202B4D8: .word 0x020F67AA
...
sub_0202B4E4: ; 0x0202B4E4
	...
	thumb_func_start sub_0202B4E8
sub_0202B4E8: ; 0x0202B4E8
	cmp r1, #3
	bhs _0202B4F4
	add r0, #0x20
	lsl r1, r1, #3
...
_0202B4F4:
	add r0, #0x20
	bx lr
	thumb_func_end sub_0202B4E8

	thumb_func_start sub_0202B4F8
sub_0202B4F8: ; 0x0202B4F8
	push {r3, lr}
	cmp r2, #3
	bhs _0202B508
	add r0, #0x20
...
_0202B508:
	pop {r3, pc}
	.balign 4, 0
	thumb_func_end sub_0202B4F8

	thumb_func_start sub_0202B50C
...
_0202B514: .word SavArray_get
	thumb_func_end sub_0202B50C

	thumb_func_start sub_0202B518
sub_0202B518: ; 0x0202B518
	mov r0, #0x46
	lsl r0, r0, #4
	bx lr
	.balign 4, 0
	thumb_func_end sub_0202B518

	thumb_func_start sub_0202B520
sub_0202B520: ; 0x0202B520
	push {r3, r4, r5, lr}
	add r5, r0, #0
	mov r4, #0
_0202B526:
	...
	pop {r3, r4, r5, pc}
	.balign 4, 0
	thumb_func_end sub_0202B520

	thumb_func_start sub_0202B538
sub_0202B538: ; 0x0202B538
	ldr r3, _0202B540 ; =sub_0202B5B4
	mov r1, #0x14
	bx r3
	nop
_0202B540: .word sub_0202B5B4
	thumb_func_end sub_0202B538
...
_0202B552:
	pop {r3, pc}
	thumb_func_end sub_0202B544

	thumb_func_start sub_0202B554
sub_0202B554: ; 0x0202B554
	push {r4, lr}
	add r4, r3, #0
	bl sub_0202B604
	add r1, r0, #0
...
_0202B566:
	pop {r4, pc}
	thumb_func_end sub_0202B554

	thumb_func_start sub_0202B568
sub_0202B568: ; 0x0202B568
	ldr r3, _0202B570 ; =sub_0202B5DC
	mov r1, #0x14
	bx r3
	nop
_0202B570: .word sub_0202B5DC
	thumb_func_end sub_0202B568

	thumb_func_start sub_0202B574
sub_0202B574: ; 0x0202B574
	push {r3, r4, r5, lr}
	add r5, r3, #0
	bl sub_0202B604
	add r4, r0, #0
...
_0202B592:
	...
	pop {r3, r4, r5, pc}
	.balign 4, 0
	thumb_func_end sub_0202B574

	thumb_func_start sub_0202B598
sub_0202B598: ; 0x0202B598
	push {r4, lr}
	add r4, r3, #0
	bl sub_0202B604
	cmp r0, #0
...
_0202C72C: .word 0x021D2230
	...
	thumb_func_start sub_0202C730
sub_0202C730: ; 0x0202C730
	mov r0, #0x42
	lsl r0, r0, #2
	bx lr
	.balign 4, 0
	thumb_func_end sub_0202C730
...
_0202C772:
	...
	cmp r1, #6
	blt _0202C772
	ldr r0, _0202C788 ; =0x021D2AF0
	str r4, [r0]
	pop {r4, pc}
	.balign 4, 0
_0202C784: .word 0x0000FFFF
_0202C788: .word 0x021D2AF0
	thumb_func_end sub_0202C75C
...
sub_0202C848: ; 0x0202C848
	...
	thumb_func_start sub_0202C854
sub_0202C854: ; 0x0202C854
	ldr r3, _0202C85C ; =SavArray_get
	mov r1, #0xe
	bx r3
	nop
_0202C85C: .word SavArray_get
	thumb_func_end sub_0202C854
...
sub_0202FA08: ; 0x0202FA08
	...
	str r0, [r4, #0x14]
	strb r0, [r4, #0x11]
	ldr r0, _0202FA34 ; =0x020F5670
	mov r1, #8
	ldrb r0, [r0]
	strb r0, [r4, #0x12]
	ldr r0, _0202FA38 ; =0x020F566C
	ldrb r0, [r0]
	strb r0, [r4, #0x13]
	add r4, #0x18
	add r0, r4, #0
	...
	pop {r4, pc}
	nop
_0202FA34: .word 0x020F5670
_0202FA38: .word 0x020F566C
