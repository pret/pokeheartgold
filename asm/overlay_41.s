...
ov41_022465C0: ; 0x022465C0
	ldr r3, _022465C8 ; =sub_0201BB4C
	ldr r0, [r0, #0x40]
	mov r1, #2
	bx r3
	.balign 4, 0
_022465C8: .word sub_0201BB4C
...
_02246FA4:
	...
	b _0224712A
_02246FC6:
	ldr r0, _0224713C ; =gMain
	ldr r1, [r0, #0x48]
	mov r0, #3
	and r1, r0
	ldr r0, _02247140 ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	orr r0, r1
	bne _02246FD8
_02246FD6:
...
_0224713C: .word gMain
_02247140: .word gMain + 0x40
...
_0224BF94:
	...
	.byte 0x10, 0x00, 0x00, 0x00, 0x02, 0x01, 0x00, 0x00
