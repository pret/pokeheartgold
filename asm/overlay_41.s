...
_0224B9D0:
	...
	thumb_func_start AccessoryPortrait_OvyInit
AccessoryPortrait_OvyInit: ; 0x0224BA10
	push {r3, r4, r5, lr}
	sub sp, #0x10
	mov r2, #2
	add r4, r0, #0
...
_0224BAC8: .word gSystem + 0x60
	thumb_func_end AccessoryPortrait_OvyInit

	thumb_func_start AccessoryPortrait_OvyExec
AccessoryPortrait_OvyExec: ; 0x0224BACC
	push {r4, r5, lr}
	sub sp, #0xc
	add r4, r1, #0
	bl OverlayManager_GetData
...
_0224BBA0: .word 0x000005DD
	thumb_func_end AccessoryPortrait_OvyExec

	thumb_func_start AccessoryPortrait_OvyExit
AccessoryPortrait_OvyExit: ; 0x0224BBA4
	push {r3, r4, r5, lr}
	add r5, r0, #0
	bl OverlayManager_GetData
	add r4, r0, #0
	...
	pop {r3, r4, r5, pc}
	.balign 4, 0
	thumb_func_end AccessoryPortrait_OvyExit
