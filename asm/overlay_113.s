	...
	thumb_func_start UnownReport_OvyInit
UnownReport_OvyInit: ; 0x021E5900
	push {r4, r5, r6, lr}
	add r5, r1, #0
	ldr r1, [r5]
	add r6, r0, #0
...
_021E5964:
	mov r0, #0
	pop {r4, r5, r6, pc}
	thumb_func_end UnownReport_OvyInit

	thumb_func_start UnownReport_OvyExec
UnownReport_OvyExec: ; 0x021E5968
	push {r3, r4, r5, lr}
	add r4, r1, #0
	bl OverlayManager_GetData
	ldr r1, [r4]
...
_021E59B2:
	...
	mov r0, #0
	pop {r3, r4, r5, pc}
	thumb_func_end UnownReport_OvyExec

	thumb_func_start UnownReport_OvyExit
UnownReport_OvyExit: ; 0x021E59C8
	push {r3, r4, r5, lr}
	add r5, r0, #0
	bl OverlayManager_GetData
	add r4, r0, #0
...
_021E59DE:
	...
	mov r0, #1
	pop {r3, r4, r5, pc}
	thumb_func_end UnownReport_OvyExit
