...
_021E5BB4:
	...
	ldr r0, [r4, r0]
	lsl r1, r0, #2
	ldr r0, _021E5E20 ; =ov61_021E7398
	ldr r0, [r0, r1]
	mov r1, #0
	lsl r0, r0, #0x10
	lsr r0, r0, #0x10
...
_021E5DBC:
	...
	ldr r3, _021E5E44 ; =ov61_021E73A4
	strh r1, [r0, #0x1e]
	ldmia r3!, {r0, r1}
	add r2, sp, #0x30
	stmia r2!, {r0, r1}
...
_021E5EAE:
	...
	ldr r3, _021E5F64 ; =ov61_021E73BC
	strh r1, [r0, #8]
...
ov61_021E60C8: ; 0x021E60C8
	push {r4, lr}
	sub sp, #0x28
	ldr r4, _021E60E4 ; =ov61_021E7494
	add r3, sp, #0
	mov r2, #5
_021E60D2:
	ldmia r4!, {r0, r1}
...
ov61_021E60E8: ; 0x021E60E8
	...
	str r4, [sp, #0x10]
	bl sub_0200B150
	ldr r5, _021E6138 ; =ov61_021E73F8
	add r3, sp, #0x14
	add r2, r3, #0
	ldmia r5!, {r0, r1}
	stmia r3!, {r0, r1}
...
ov61_021E6350: ; 0x021E6350
	...
	ldrh r2, [r1]
	mov r0, #3
	ldr r6, _021E6474 ; =ov61_021E745C
	bic r2, r0
	mov r0, #2
	orr r0, r2
	strh r0, [r1]
	...
	ldr r6, _021E6478 ; =ov61_021E7478
	add r3, sp, #0x54
	ldmia r6!, {r0, r1}
	add r2, r3, #0
	stmia r3!, {r0, r1}
	...
	mov r1, #2
	bl BgClearTilemapBufferAndCommit
	ldr r6, _021E647C ; =ov61_021E7408
	add r3, sp, #0x38
	ldmia r6!, {r0, r1}
	add r2, r3, #0
	stmia r3!, {r0, r1}
	...
	mov r1, #4
	bl BgClearTilemapBufferAndCommit
	ldr r6, _021E6480 ; =ov61_021E7424
	add r3, sp, #0x1c
	ldmia r6!, {r0, r1}
	add r2, r3, #0
	stmia r3!, {r0, r1}
	...
	mov r1, #5
	bl BgClearTilemapBufferAndCommit
	ldr r6, _021E6484 ; =ov61_021E7440
	add r3, sp, #0
	ldmia r6!, {r0, r1}
	add r2, r3, #0
	stmia r3!, {r0, r1}
...
_021E6474: .word ov61_021E745C
_021E6478: .word ov61_021E7478
_021E647C: .word ov61_021E7408
_021E6480: .word ov61_021E7424
_021E6484: .word ov61_021E7440
...
ov61_021E6488: ; 0x021E6488
	push {r3, r4, lr}
	sub sp, #0x2c
	ldr r3, _021E64FC ; =ov61_021E73C8
	add r4, r0, #0
	ldmia r3!, {r0, r1}
	add r2, sp, #0x14
	stmia r2!, {r0, r1}
