	...
	thumb_func_start MoveRelearner_OvyInit
MoveRelearner_OvyInit: ; 0x021E5900
	push {r3, r4, r5, lr}
	mov r2, #9
	add r5, r0, #0
	mov r0, #3
...
_021E5964: .word ov68_021E5B6C
	thumb_func_end MoveRelearner_OvyInit

	thumb_func_start MoveRelearner_OvyExec
MoveRelearner_OvyExec: ; 0x021E5968
	push {r3, r4, r5, lr}
	add r4, r1, #0
...
_021E5A22:
	...
	pop {r3, r4, r5, pc}
	.balign 4, 0
	thumb_func_end MoveRelearner_OvyExec

	thumb_func_start MoveRelearner_OvyExit
MoveRelearner_OvyExit: ; 0x021E5A3C
	push {r4, lr}
	add r4, r0, #0
	bl OverlayManager_GetData
	bl ov68_021E5B14
	...
	mov r0, #1
	pop {r4, pc}
	thumb_func_end MoveRelearner_OvyExit
...
ov68_021E74D8: ; 0x021E74D8
	...
	mov r1, #0x17
	lsl r1, r1, #4
	ldr r0, _021E7564 ; =gOvyTemplate_PokemonSummary
	add r1, r4, r1
	mov r2, #0x42
...
_021E7564: .word gOvyTemplate_PokemonSummary
