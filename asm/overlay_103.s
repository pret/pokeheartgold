...
ov103_021ECFFC: ; 0x021ECFFC
	...
	mov r0, #0x91
	lsl r0, r0, #2
	ldr r3, _021ED008 ; =TouchscreenListMenu_Destroy
	ldr r0, [r1, r0]
	bx r3
	.balign 4, 0
_021ED008: .word TouchscreenListMenu_Destroy
...
ov103_021EE0F8: ; 0x021EE0F8
	...
	add r1, r2, #0
	add r2, r3, #0
	ldr r3, _021EE10C ; =ManagedSprite_SetPositionXY
	bx r3
	nop
_021EE10C: .word ManagedSprite_SetPositionXY
...
ov103_021EE150: ; 0x021EE150
	mov r1, #0x9d
	lsl r1, r1, #2
	ldr r3, _021EE15C ; =NARC_Delete
	ldr r0, [r0, r1]
	bx r3
	nop
_021EE15C: .word NARC_Delete
