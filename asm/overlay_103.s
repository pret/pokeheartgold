...
_021ED50E:
	...
	add r0, r4, #0
	lsl r2, r1, #3
	ldr r1, _021ED538 ; =ov103_021EEC6C
	ldr r1, [r1, r2]
	blx r1
	pop {r4, pc}
_021ED52E:
...
_021ED57A:
	...
	add r3, r2, #0
	mul r3, r1
	ldr r1, _021ED5A0 ; =ov103_021EEC7C
	add r0, r4, #0
	ldr r1, [r1, r3]
	blx r1
	str r0, [r4, #0x28]
	...
	add r2, r1, #0
	mul r2, r0
	ldr r0, _021ED5A4 ; =ov103_021EEC80
	ldr r0, [r0, r2]
	pop {r4, pc}
	.balign 4, 0
_021ED5A0: .word ov103_021EEC7C
_021ED5A4: .word ov103_021EEC80
...
ov103_021EEC58: ; 0x021EEC58
	.byte 0x25, 0x59, 0x1E, 0x02, 0x8D, 0x59, 0x1E, 0x02
	.byte 0xE9, 0x5A, 0x1E, 0x02, 0x37, 0x00, 0x00, 0x00

ov103_021EEC68: ; 0x021EEC68
	.byte 0xE5, 0xDD, 0x1E, 0x02

ov103_021EEC6C: ; 0x021EEC6C
	.byte 0xD9, 0xD9, 0x1E, 0x02
	.byte 0x5D, 0xDE, 0x1E, 0x02, 0x7D, 0xDE, 0x1E, 0x02

ov103_021EEC78: ; 0x021EEC78
	.byte 0xC9, 0xDC, 0x1E, 0x02

ov103_021EEC7C: ; 0x021EEC7C
	.byte 0xE1, 0xDC, 0x1E, 0x02

ov103_021EEC80: ; 0x021EEC80
	...
	.byte 0x49, 0xDD, 0x1E, 0x02, 0x00, 0x00, 0x00, 0x00

ov103_021EECA8: ; 0x021EECA8
	.byte 0x15, 0xD3, 0x1E, 0x02, 0xE9, 0xD3, 0x1E, 0x02
	...
	.byte 0x9D, 0xD9, 0x1E, 0x02, 0xAD, 0xD9, 0x1E, 0x02, 0xD9, 0xD9, 0x1E, 0x02
...
ov103_021EEFC8: ; 0x021EEFC8
	.byte 0xB1, 0xEA, 0x1E, 0x02, 0xB5, 0xEA, 0x1E, 0x02
	.byte 0xB9, 0xEA, 0x1E, 0x02, 0xC1, 0xEA, 0x1E, 0x02
