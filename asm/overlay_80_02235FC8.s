...
_02236290:
	...
	str r3, [sp]
	add r5, #0xa8
	ldr r1, _022362B4 ; =gOvyTemplate_PartyMenu
	ldr r2, [r5]
	add r0, r6, #0
	bl sub_02096820
	add sp, #4
	pop {r3, r4, r5, r6, pc}
	nop
_022362B4: .word gOvyTemplate_PartyMenu
...
ov80_02236330: ; 0x02236330
	...
	str r3, [sp]
	add r4, #0xac
	ldr r1, _02236418 ; =gOvyTemplate_PokemonSummary
	ldr r2, [r4]
	add r0, r5, #0
	bl sub_02096820
	pop {r3, r4, r5, pc}
...
_02236418: .word gOvyTemplate_PokemonSummary
