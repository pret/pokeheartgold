...
_0202BAFE:
	...
	thumb_func_start GiveFashionItem
GiveFashionItem: ; 0x0202BB08
	push {r4, r5, r6, lr}
	add r4, r1, #0
	add r5, r0, #0
	add r6, r2, #0
...
_0202BB64:
	...
	pop {r4, r5, r6, pc}
	.balign 4, 0
	thumb_func_end GiveFashionItem
...
_0202BBC2:
	...
	thumb_func_start GiveContestBackground
GiveContestBackground: ; 0x0202BBD8
	push {r3, r4, r5, lr}
	add r4, r1, #0
	add r5, r0, #0
	cmp r4, #0x12
...
_0202BC0C:
	pop {r3, r4, r5, pc}
	.balign 4, 0
	thumb_func_end GiveContestBackground
