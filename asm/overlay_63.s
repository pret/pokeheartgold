...
_0221F86C:
	...
	bl G3B_LightVector
	ldrh r0, [r4, #0x28]
	ldr r3, _0221FA90 ; =_021094DC
	asr r0, r0, #4
	lsl r1, r0, #2
	ldr r0, _0221FA90 ; =_021094DC
	add r2, r0, r1
	ldrsh r1, [r3, r1]
	mov r3, #2
	ldrsh r2, [r2, r3]
...
ov63_0221FD18: ; 0x0221FD18
	.byte 0xF9, 0xC1, 0x21, 0x02, 0x15, 0xC2, 0x21, 0x02
	.byte 0x29, 0xC2, 0x21, 0x02, 0x65, 0xC2, 0x21, 0x02, 0x69, 0xC3, 0x21, 0x02, 0x85, 0xC3, 0x21, 0x02
	.byte 0xCD, 0xC3, 0x21, 0x02, 0xA1, 0xC5, 0x21, 0x02
