...
_0221CFFC:
	...
	pop {r4, r5, r6, r7, pc}
	.balign 4, 0
_0221D0C0: .word 0x0221FD58
_0221D0C4: .word 0x0221FDF0
_0221D0C8: .word 0x0221FDB8
_0221D0CC: .word 0x0221FE0C
_0221D0D0: .word 0x0221FE28
_0221D0D4: .word 0x0221FD80
_0221D0D8: .word 0x0221FD9C
_0221D0DC: .word 0x0221FDD4
...
_0221D8B0: .word 0x0221FEA4
_0221D8B4: .word 0x0221FEA8
...
_0221DB94:
	...
	pop {r4, r5, r6, r7, pc}
	nop
_0221DBE4: .word 0x0221FF4C
_0221DBE8: .word 0x00000424
_0221DBEC: .word 0x0221FEA4
...
_0221DD96:
	...
	pop {r3, r4, r5, r6, pc}
	nop
_0221DDAC: .word 0x0221FF4C
_0221DDB0: .word 0x0221FF50
_0221DDB4: .word 0x0221FD70
_0221DDB8: .word 0x0221FD68
_0221DDBC: .word 0x0221FD6C
...
ov65_0221E2C0: ; 0x0221E2C0
	...
	sub sp, #0x10
	add r4, r0, #0
	ldr r0, _0221E31C ; =gMain
	ldr r1, [r0, #0x48]
	mov r0, #1
	tst r0, r1
	bne _0221E2D8
	ldr r0, _0221E320 ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	cmp r0, #0
	beq _0221E316
_0221E2D8:
...
_0221E316:
	...
	pop {r4, pc}
	.balign 4, 0
_0221E31C: .word gMain
_0221E320: .word gMain + 0x40
...
_0221ED68: .word 0x0221FF4C
_0221ED6C: .word 0x000022D0
_0221ED70: .word 0x0221FF50
...
_0221FAD8: .word 0x0222010C
_0221FADC: .word 0x02220144
