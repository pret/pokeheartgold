...
ov101_021EEDC4: ; 0x021EEDC4
	...
	ldr r0, [r0, #0x7c]
	mov r2, #1
	bl PokegearCursorManager_SetCursorSpritesAnimateFlag
	cmp r4, #0
	bne _021EEE06
	mov r0, #4
	pop {r3, r4, r5, pc}
...
ov101_021EF0E0: ; 0x021EF0E0
	...
	ldr r0, [r4, #0xc]
	ldr r0, [r0, #0x7c]
	bl PokegearCursorManager_AddButtons
	ldr r0, [r4, #0xc]
	mov r1, #1
	ldr r0, [r0, #0x7c]
	mov r2, #0
	bl PokegearCursorManager_SetCursorSpritesDrawState
	add sp, #0x18
	pop {r4, pc}
	nop
...
ov101_021EF120: ; 0x021EF120
	ldr r0, [r0, #0xc]
	ldr r3, _021EF12C ; =PokegearCursorManager_RemoveCursor
	ldr r0, [r0, #0x7c]
	mov r1, #1
	bx r3
	nop
_021EF12C: .word PokegearCursorManager_RemoveCursor
...
ov101_021EF17C: ; 0x021EF17C
	...
	mov r1, #0
	ldr r0, [r0, #0x7c]
	bl PokegearCursorManager_SetSpecIndexAndCursorPos
	pop {r4, pc}
_021EF1B6:
	mov r1, #0
	add r2, r1, #0
...
_021EF730:
	...
	ldr r0, [r4, #0xc]
	ldr r0, [r0, #0x7c]
	bl PokegearCursorManager_GetCursorPos
	add r5, r0, #0
	add r0, r4, #0
	add r1, r5, #0
	bl ov101_021EF6D0
...
_021EF766:
	...
	mov r1, #0
	ldr r0, [r0, #0x7c]
	bl PokegearCursorManager_MoveActiveCursor
...
_021EF818:
	...
	ldr r0, [r0, #0x7c]
	lsr r1, r1, #0x18
	bl PokegearCursorManager_SetActiveCursorPosition
	lsl r1, r4, #0x18
	add r0, r5, #0
	lsr r1, r1, #0x18
	bl ov101_021EF50C
