...
_022378E0:
	...
	thumb_func_start ApricornBox_OvyInit
ApricornBox_OvyInit: ; 0x022378E4
	push {r3, r4, r5, lr}
	add r5, r0, #0
	bl ov58_02237CCC
	mov r2, #2
	...
	pop {r3, r4, r5, pc}
	.balign 4, 0
	thumb_func_end ApricornBox_OvyInit

	thumb_func_start ApricornBox_OvyExec
ApricornBox_OvyExec: ; 0x02237924
	push {r4, lr}
	add r4, r1, #0
...
_02237996:
	...
	pop {r4, pc}
	.balign 4, 0
	thumb_func_end ApricornBox_OvyExec

	thumb_func_start ApricornBox_OvyExit
ApricornBox_OvyExit: ; 0x0223799C
	push {r3, r4, r5, lr}
	add r5, r0, #0
	bl OverlayManager_GetData
	add r4, r0, #0
	...
	mov r0, #1
	pop {r3, r4, r5, pc}
	thumb_func_end ApricornBox_OvyExit
...
ov58_02237BD4: ; 0x02237BD4
	...
	add r0, #0x26
	strb r1, [r0]
	ldr r0, _02237C48 ; =gOvyTemplate_PartyMenu
	ldr r2, [r5]
	add r1, r4, #0
	bl OverlayManager_New
	str r0, [r5, #8]
	...
	pop {r3, r4, r5, pc}
	nop
_02237C48: .word gOvyTemplate_PartyMenu
