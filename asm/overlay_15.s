...
ov15_021F99A4: ; 0x021F99A4
	...
	pop {r4, r5, pc}
	.balign 4, 0
_021F9A68: .word 0x02200518
_021F9A6C: .word 0x022006CC
_021F9A70: .word 0x022006E8
_021F9A74: .word 0x02200704
_021F9A78: .word 0x02200720
_021F9A7C: .word 0x0220073C
_021F9A80: .word 0x02200758
_021F9A84: .word 0x02200774
...
_021FA47E:
	...
	b _021FA4C0
	nop
_021FA4A4: .word gMain
_021FA4A8: .word 0x00000644
_021FA4AC: .word 0x02200640
_021FA4B0: .word 0x02200641
_021FA4B4: .word 0x02200642
_021FA4B8: .word 0x02200643
...
_021FA67C:
	...
	pop {r4, pc}
	.balign 4, 0
_021FA680: .word gMain
_021FA684: .word 0x02201480
_021FA688: .word 0x02201300
...
_021FAD6A:
	bx lr
	.balign 4, 0
_021FAD6C: .word gMain
_021FAD70: .word 0x02200584
_021FAD74: .word 0x02200585
_021FAD78: .word 0x02200586
_021FAD7C: .word 0x02200587
...
_021FB4FC: .word gMain
_021FB500: .word 0x02200528
_021FB504: .word 0x02200529
_021FB508: .word 0x0220052A
_021FB50C: .word 0x0220052B
_021FB510: .word 0x02201468
...
ov15_021FB700: ; 0x021FB700
	...
	cmp r0, #0
	bne _021FB772
	ldr r0, _021FB77C ; =gMain
	ldr r1, [r0, #0x48]
	mov r0, #3
	tst r0, r1
	bne _021FB722
	ldr r0, _021FB780 ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	cmp r0, #0
	beq _021FB772
_021FB722:
...
_021FB77C: .word gMain
_021FB780: .word gMain + 0x40
...
_021FB8AC:
	...
	cmp r0, #0
	bne _021FB936
	ldr r0, _021FB9CC ; =gMain
	ldr r1, [r0, #0x48]
	mov r0, #3
	tst r0, r1
	bne _021FB8CA
	ldr r0, _021FB9D0 ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	cmp r0, #0
	beq _021FB9BA
_021FB8CA:
...
_021FB9CC: .word gMain
_021FB9D0: .word gMain + 0x40
...
_021FBBD4:
	...
	cmp r0, #0
	bne _021FBC56
	ldr r0, _021FBC64 ; =gMain
	ldr r1, [r0, #0x48]
	mov r0, #3
	tst r0, r1
	bne _021FBBF2
	ldr r0, _021FBC68 ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	cmp r0, #0
	beq _021FBC56
_021FBBF2:
...
_021FBC64: .word gMain
_021FBC68: .word gMain + 0x40
...
ov15_021FC164: ; 0x021FC164
	...
	cmp r0, #0
	bne _021FC214
	ldr r0, _021FC21C ; =gMain
	ldr r1, [r0, #0x48]
	mov r0, #3
	tst r0, r1
	bne _021FC186
	ldr r0, _021FC220 ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	cmp r0, #0
	beq _021FC214
_021FC186:
...
_021FC21C: .word gMain
_021FC220: .word gMain + 0x40
...
ov15_021FC2E0: ; 0x021FC2E0
	...
	cmp r0, #0
	bne _021FC36A
	ldr r0, _021FC374 ; =gMain
	ldr r1, [r0, #0x48]
	mov r0, #3
	tst r0, r1
	bne _021FC302
	ldr r0, _021FC378 ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	cmp r0, #0
	beq _021FC36A
_021FC302:
...
_021FC374: .word gMain
_021FC378: .word gMain + 0x40
...
_021FC6E4:
	...
	b _021FC72C
	.balign 4, 0
_021FC70C: .word gMain
_021FC710: .word 0x00000644
_021FC714: .word 0x02200640
_021FC718: .word 0x02200641
_021FC71C: .word 0x02200642
_021FC720: .word 0x02200643
...
ov15_021FC784: ; 0x021FC784
	...
	cmp r0, #0
	bne _021FC7DC
	ldr r0, _021FC7E4 ; =gMain
	ldr r1, [r0, #0x48]
	mov r0, #3
	tst r0, r1
	bne _021FC7A6
	ldr r0, _021FC7E8 ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	cmp r0, #0
	beq _021FC7DC
_021FC7A6:
...
_021FC7E4: .word gMain
_021FC7E8: .word gMain + 0x40
...
_021FCA8A:
	...
	b _021FCACC
	.balign 4, 0
_021FCAB0: .word gMain
_021FCAB4: .word 0x00000644
_021FCAB8: .word 0x02200640
_021FCABC: .word 0x02200641
_021FCAC0: .word 0x02200642
_021FCAC4: .word 0x02200643
...
ov15_021FD2FC: ; 0x021FD2FC
	...
	cmp r0, #0
	bne _021FD396
	ldr r0, _021FD3A0 ; =gMain
	ldr r1, [r0, #0x48]
	mov r0, #3
	tst r0, r1
	bne _021FD31E
	ldr r0, _021FD3A4 ; =gMain + 0x40
	ldrh r0, [r0, #0x24]
	cmp r0, #0
	beq _021FD396
_021FD31E:
...
_021FD3A0: .word gMain
_021FD3A4: .word gMain + 0x40
...
_021FD566:
	...
	pop {r4, r5, r6, r7, pc}
	nop
_021FD56C: .word 0x02201340
_021FD570: .word 0x02201328
...
_021FDAA8: .word 0x02201304
_021FDAAC: .word 0x00000818
_021FDAB0: .word 0x02200500
_021FDAB4: .word 0x0220053C
_021FDAB8: .word 0x0000091C
_021FDABC: .word 0x00000934
_021FDAC0: .word 0x0220050C
...
_021FDC94:
	...
	pop {r4, r5, pc}
	.balign 4, 0
_021FDD34: .word 0x022005CC
_021FDD38: .word 0x022004F4
...
_021FE3C8: .word 0x022008E8
_021FE3CC: .word 0x000002FB
_021FE3D0: .word 0x022008D0
...
ov15_021FE868: ; 0x021FE868
	ldr r3, _021FE870 ; =sub_0201D8E4
	add r0, #0x14
	bx r3
	nop
_021FE870: .word sub_0201D8E4
...
ov15_021FF560: ; 0x021FF560
	mov r1, #0x5d
	lsl r1, r1, #2
	ldr r3, _021FF56C ; =sub_0201D8E4
	add r0, r0, r1
	bx r3
	nop
_021FF56C: .word sub_0201D8E4
...
ov15_021FF834: ; 0x021FF834
	mov r1, #0x7d
	lsl r1, r1, #2
	ldr r3, _021FF840 ; =sub_0201D8E4
	add r0, r0, r1
	bx r3
	nop
_021FF840: .word sub_0201D8E4
	thumb_func_end ov15_021FF834

	thumb_func_start ov15_021FF844
ov15_021FF844: ; 0x021FF844
	ldr r3, _021FF84C ; =sub_0201D8E4
	add r0, #0x74
	bx r3
	nop
_021FF84C: .word sub_0201D8E4
...
ov15_021FFA40: ; 0x021FFA40
	...
	pop {r4, r5, r6, r7, pc}
	nop
_021FFAC4: .word 0x022009BC
_021FFAC8: .word 0x022009F4
_021FFACC: .word 0x022009A8
...
ov15_021FFECC: ; 0x021FFECC
	...
	pop {r3, r4, r5, pc}
	nop
_021FFF14: .word 0x02200AB8
_021FFF18: .word 0x02200AB9
_021FFF1C: .word 0x02200ABA
_021FFF20: .word 0x02200ABB
...
_021FFFA0:
	...
	pop {r3, r4, r5, pc}
	.balign 4, 0
_021FFFC8: .word 0x02200A36
_021FFFCC: .word 0x00000672
_021FFFD0: .word 0x02200A34
_021FFFD4: .word 0x02200A35
_021FFFD8: .word 0x02200A37
...
_021FFFEA:
	...
	pop {r3, r4, r5, pc}
	.balign 4, 0
_02200020: .word 0x022009D4
_02200024: .word 0x022009D5
_02200028: .word 0x022009D6
_0220002C: .word 0x022009D7
...
_022003D4:
	...
	pop {r4, r5, r6, r7, pc}
	.balign 4, 0
_02200414: .word 0x02200998
_02200418: .word 0x02200A58
_0220041C: .word 0x02200A88
_02200420: .word 0x022009A0
_02200424: .word 0x02200A14
