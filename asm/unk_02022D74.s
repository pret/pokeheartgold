...
_02023112:
	...
	thumb_func_start Camera_Create
Camera_Create: ; 0x02023114
	ldr r3, _0202311C ; =AllocFromHeap
	mov r1, #0x68
	bx r3
	nop
_0202311C: .word AllocFromHeap
	thumb_func_end Camera_Create
...
_02023130:
	...
	thumb_func_start Camera_RegisterToStaticPtr
Camera_RegisterToStaticPtr: ; 0x0202313C
	ldr r1, _02023144 ; =_021D2204
	str r0, [r1]
	bx lr
	nop
_02023144: .word _021D2204
	thumb_func_end Camera_RegisterToStaticPtr
...
_02023200: .word NNS_G3dGlb + 0x80
	...
	thumb_func_start Camera_SetBindTarget
Camera_SetBindTarget: ; 0x02023204
	add r3, r0, #0
	add r2, r1, #0
	ldmia r3!, {r0, r1}
	add r2, #0x2c
	...
	str r0, [r2]
	bx lr
	thumb_func_end Camera_SetBindTarget
...
sub_02023234: ; 0x02023234
	...
	thumb_func_start Camera_SetClipBounds
Camera_SetClipBounds: ; 0x02023240
	str r0, [r2, #0xc]
	add r0, r2, #0
	str r1, [r2, #0x10]
	add r0, #0x44
...
_02023250: .word sub_020233D8
	thumb_func_end Camera_SetClipBounds

	thumb_func_start Camera_InitFromTargetDistanceAndAngle
Camera_InitFromTargetDistanceAndAngle: ; 0x02023254
	push {r3, r4, r5, r6, r7, lr}
	ldr r4, [sp, #0x20]
	add r6, r0, #0
	add r7, r1, #0
...
_02023490: .word _0210F6DC
	...
	thumb_func_start Camera_SetPerspectiveAngle
Camera_SetPerspectiveAngle: ; 0x02023494
	add r2, r1, #0
	add r2, #0x46
	strh r0, [r2]
	add r0, r1, #0
...
_020234CC: .word FX_SinCosTable_
	thumb_func_end Camera_SetPerspectiveAngle
...
_02023510: .word FX_SinCosTable_
	...
	thumb_func_start Camera_ShiftBy
Camera_ShiftBy: ; 0x02023514
	push {r3, r4, r5, lr}
	add r4, r1, #0
	add r5, r0, #0
	add r0, r4, #0
...
_02023554: .word sub_02022E54
	...
	thumb_func_start Camera_SetAngle
Camera_SetAngle: ; 0x02023558
	ldrh r2, [r0]
	strh r2, [r1, #0x3c]
	ldrh r2, [r0, #2]
	strh r2, [r1, #0x3e]
...
_02023578: .word sub_02022D74
	thumb_func_end Camera_SetAngle
...
_020235D0: .word sub_02022D74
	...
	thumb_func_start Camera_SetDistance
Camera_SetDistance: ; 0x020235D4
...
_020235DC: .word sub_02022D74
	thumb_func_end Camera_SetDistance
...
_02023608: .word sub_02022D74
	...
	thumb_func_start Camera_GetPerspectiveAngle
Camera_GetPerspectiveAngle: ; 0x0202360C
	add r0, #0x46
	ldrh r0, [r0]
	bx lr
	.balign 4, 0
	thumb_func_end Camera_GetPerspectiveAngle

	thumb_func_start Camera_GetDistance
Camera_GetDistance: ; 0x02023614
	ldr r0, [r0, #0x38]
	bx lr
	thumb_func_end Camera_GetDistance

	thumb_func_start Camera_GetAngle
Camera_GetAngle: ; 0x02023618
	ldrh r2, [r1, #0x3c]
	strh r2, [r0]
	ldrh r2, [r1, #0x3e]
	strh r2, [r0, #2]
	...
	strh r1, [r0, #6]
	bx lr
	thumb_func_end Camera_GetAngle

	thumb_func_start Camera_GetTarget
Camera_GetTarget: ; 0x02023630
	add r2, r1, #0
	add r2, #0x20
	add r3, r0, #0
	ldmia r2!, {r0, r1}
	...
	str r0, [r3]
	bx lr
	thumb_func_end Camera_GetTarget
...
sub_02023654: ; 0x02023654
	...
	thumb_func_start Camera_GetBindTarget
Camera_GetBindTarget: ; 0x02023658
	ldr r0, [r0, #0x54]
	bx lr
	thumb_func_end Camera_GetBindTarget
