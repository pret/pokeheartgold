...
#ifndef _MSL_HIWARE_FLOAT_MATH
#define _MSL_HIWARE_FLOAT_MATH 0
#endif
...
#ifndef _MSL_COMPLEX
	#if defined(__MWERKS__) && __CWCC__>=0x4100
		#if __has_feature(C99_COMPLEX) && __option(c99)
			#define _MSL_COMPLEX 1
		#else
