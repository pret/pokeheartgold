...
_000:
    ...
    CompareMonDataToValue OPCODE_EQU, BATTLER_CATEGORY_DEFENDER, BMON_DATA_FORM, SHAYMIN_FORM_LAND, _END
    ...
    UpdateMonData OPCODE_SET, BATTLER_CATEGORY_DEFENDER, BMON_DATA_FORM, SHAYMIN_FORM_LAND
    UpdateVar OPCODE_SET, BSCRIPT_VAR_TEMP_DATA, SHAYMIN_FORM_LAND
    CompareMonDataToValue OPCODE_FLAG_SET, BATTLER_CATEGORY_DEFENDER, BMON_DATA_PERSONALITY, 1, _ATTEMPT_LOAD_SECOND_ABILITY
    LoadArchivedMonData SPECIES_SHAYMIN, BSCRIPT_VAR_TEMP_DATA, SPECIES_DATA_ABILITY_1
    GoTo _062

_ATTEMPT_LOAD_SECOND_ABILITY:
    LoadArchivedMonData SPECIES_SHAYMIN, BSCRIPT_VAR_TEMP_DATA, SPECIES_DATA_ABILITY_2
...
_062:
    ...
    LoadArchivedMonData SPECIES_SHAYMIN, BSCRIPT_VAR_TEMP_DATA, SPECIES_DATA_TYPE_1
    UpdateMonDataFromVar OPCODE_SET, BATTLER_CATEGORY_DEFENDER, BMON_DATA_TYPE_1, BSCRIPT_VAR_CALC_TEMP
    LoadArchivedMonData SPECIES_SHAYMIN, BSCRIPT_VAR_TEMP_DATA, SPECIES_DATA_TYPE_2
