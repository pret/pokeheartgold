...
sub_037F8B7C: @ 0x037F8B7C
	...
	bx ip
	.align 2, 0
_037F8B90: .4byte sub_037F8A3C
_037F8B94: .4byte 0x027FFFE8
_037F8B98: .4byte sub_037F8BCC
...
sub_037F8BA8: @ 0x037F8BA8
	...
	bx ip
	.align 2, 0
_037F8BBC: .4byte sub_037F8AB8
_037F8BC0: .4byte 0x027FFFE8
_037F8BC4: .4byte sub_037F8BC8
...
sub_037F8BD0: @ 0x037F8BD0
	...
	bx ip
	.align 2, 0
_037F8BE4: .4byte sub_037F8A3C
_037F8BE8: .4byte 0x027FFFE0
_037F8BEC: .4byte sub_037F8C14
...
sub_037F8BF0: @ 0x037F8BF0
	...
	bx ip
	.align 2, 0
_037F8C04: .4byte sub_037F8AB8
_037F8C08: .4byte 0x027FFFE0
_037F8C0C: .4byte sub_037F8C10
...
_037F8CE4: .4byte 0x027FFFB8
	...
	arm_func_start sub_037F8CE8
sub_037F8CE8: @ 0x037F8CE8
	ldr ip, [r0]
	b _037F8CFC
_037F8CF0:
	cmp ip, r1
...
_037F8D40:
	...
	str r1, [ip, #0x60]
	bx lr
	arm_func_end sub_037F8CE8

	arm_func_start sub_037F8D60
sub_037F8D60: @ 0x037F8D60
	push {r3, lr}
	ldr lr, [r0]
	mov r2, lr
	b _037F8DA4
...
_037F8DAC:
	...
	pop {r3, lr}
	bx lr
	arm_func_end sub_037F8D60

	arm_func_start sub_037F8DB8
sub_037F8DB8: @ 0x037F8DB8
	ldr r2, [r0]
	cmp r2, #0
	beq _037F8DE0
	ldr r1, [r2, #0x10]
...
_037F8DE0:
	mov r0, r2
	bx lr
	arm_func_end sub_037F8DB8

	arm_func_start sub_037F8DE8
sub_037F8DE8: @ 0x037F8DE8
	push {r3, lr}
...
_037F8E44: .4byte 0x03806C1C
	arm_func_end sub_037F8DE8

	arm_func_start sub_037F8E48
sub_037F8E48: @ 0x037F8E48
...
_037F8E88: .4byte 0x03806C1C
	arm_func_end sub_037F8E48

	arm_func_start sub_037F8E8C
sub_037F8E8C: @ 0x037F8E8C
	push {r4, r5, r6, lr}
...
_037F8F5C: .4byte 0x03806C40
	arm_func_end sub_037F8E8C

	arm_func_start sub_037F8F60
sub_037F8F60: @ 0x037F8F60
	push {r3, lr}
...
_037F9050: .4byte 0x027FFFA4
	arm_func_end sub_037F8F60

	arm_func_start sub_037F9054
sub_037F9054: @ 0x037F9054
	push {r4, r5, r6, r7, r8, lr}
	mov r8, r0
	mov r5, r1
	mov r7, r2
...
_037F9158: .4byte sub_037F915C
	arm_func_end sub_037F9054

	arm_func_start sub_037F915C
sub_037F915C: @ 0x037F915C
	push {r3, lr}
	bl sub_037FAD24
...
_037F917C: .4byte 0x03806C1C
	arm_func_end sub_037F915C

	arm_func_start sub_037F9180
sub_037F9180: @ 0x037F9180
	push {r3, r4, r5, lr}
...
_037F91DC: .4byte sub_037F91E0
	arm_func_end sub_037F9180

	arm_func_start sub_037F91E0
sub_037F91E0: @ 0x037F91E0
	push {r3, lr}
...
_037F921C: .4byte 0x03806C1C
	...
	arm_func_start sub_037F9220
sub_037F9220: @ 0x037F9220
	push {r4, lr}
...
_037F928C: .4byte 0x03806C1C
	arm_func_end sub_037F9220

	arm_func_start sub_037F9290
sub_037F9290: @ 0x037F9290
	push {r3, r4, r5, lr}
	mov r5, r0
	bl sub_037FAD24
	ldr r1, [r5, #0x48]
...
_037F92B4:
	...
	pop {r3, r4, r5, lr}
	bx lr
	arm_func_end sub_037F9290

	arm_func_start sub_037F92C4
sub_037F92C4: @ 0x037F92C4
	ldr r0, [r0, #0x48]
	cmp r0, #2
	moveq r0, #1
	movne r0, #0
	bx lr
	arm_func_end sub_037F92C4

	arm_func_start sub_037F92D8
sub_037F92D8: @ 0x037F92D8
	push {r4, r5, r6, lr}
	mov r6, r0
	bl sub_037FAD24
...
_037F9328: .4byte 0x03806C1C
	arm_func_end sub_037F92D8

	arm_func_start sub_037F932C
sub_037F932C: @ 0x037F932C
	push {r3, r4, r5, lr}
	mov r5, r0
	bl sub_037FAD24
	ldr r1, [r5]
...
_037F93A4:
	...
	pop {r3, r4, r5, lr}
	bx lr
	arm_func_end sub_037F932C

	arm_func_start sub_037F93B4
sub_037F93B4: @ 0x037F93B4
	push {r3, r4, r5, lr}
	mov r5, r0
	bl sub_037FAD24
	mov r1, #1
	...
	pop {r3, r4, r5, lr}
	bx lr
	arm_func_end sub_037F93B4

	arm_func_start sub_037F93E0
sub_037F93E0: @ 0x037F93E0
...
_037F9404: .4byte 0x03806C1C
	arm_func_end sub_037F93E0

	arm_func_start sub_037F9408
sub_037F9408: @ 0x037F9408
	push {r4, r5, r6, r7, r8, lr}
...
_037F94AC: .4byte 0x03806C50
	arm_func_end sub_037F9408

	arm_func_start sub_037F94B0
sub_037F94B0: @ 0x037F94B0
	push {r4, r5, lr}
	sub sp, sp, #0x34
	mov r5, r0
	add r0, sp, #8
...
_037F9544: .4byte sub_037F9548
	arm_func_end sub_037F94B0

	arm_func_start sub_037F9548
sub_037F9548: @ 0x037F9548
	ldr r2, [r0]
	mov r1, #0
	str r1, [r0]
	ldr ip, _037F9564 @ =sub_037F93B4
	mov r0, r2
	str r1, [r2, #0x94]
	bx ip
	.align 2, 0
_037F9564: .4byte sub_037F93B4
	arm_func_end sub_037F9548

	arm_func_start sub_037F9568
sub_037F9568: @ 0x037F9568
	push {r3, r4, r5, lr}
	mov r5, r0
	bl sub_037FAD24
...
_037F9590: .4byte 0x03806C1C
	arm_func_end sub_037F9568

	arm_func_start sub_037F9594
sub_037F9594: @ 0x037F9594
	push {r4, lr}
	bl sub_037FAD24
...
_037F95C8: .4byte 0x03806C1C
	arm_func_end sub_037F9594

	arm_func_start sub_037F95CC
sub_037F95CC: @ 0x037F95CC
	push {r4, lr}
	bl sub_037FAD24
...
_037F9600: .4byte 0x03806C1C
	arm_func_end sub_037F95CC

	arm_func_start sub_037F9604
sub_037F9604: @ 0x037F9604
	add r1, r1, #4
	str r1, [r0, #0x40]
	str r2, [r0, #0x44]
	sub r2, r2, #0x40
	...
	str r1, [r0, #0x3c]
	bx lr
	arm_func_end sub_037F9604

	arm_func_start sub_037F9670
sub_037F9670: @ 0x037F9670
	add r1, r0, #0
	mrs r2, apsr
	str r2, [r1], #4
	mov r0, #0xd3
	...
	add r0, pc, #0x8 @ =sub_037F96A4
	str r0, [r1, #0x3c]
	mov r0, #0
	bx lr
	arm_func_end sub_037F9670

	arm_func_start sub_037F96A4
sub_037F96A4: @ 0x037F96A4
	mrs r1, apsr
	bic r1, r1, #0x1f
	orr r1, r1, #0xd3
	msr cpsr_c, r1
	...
	mov r0, r0
	subs pc, lr, #4
	arm_func_end sub_037F96A4

	arm_func_start sub_037F96D0
sub_037F96D0: @ 0x037F96D0
	mov r3, #0
	str r3, [r0, #4]
	str r3, [r0]
	str r3, [r0, #0xc]
	...
	str r3, [r0, #0x1c]
	bx lr
	arm_func_end sub_037F96D0

	arm_func_start sub_037F96F8
sub_037F96F8: @ 0x037F96F8
	push {r3, r4, r5, r6, r7, lr}
	mov r7, r2
	mov r6, r0
	mov r5, r1
...
_037F977C:
	pop {r3, r4, r5, r6, r7, lr}
	bx lr
	arm_func_end sub_037F96F8

	arm_func_start sub_037F9784
sub_037F9784: @ 0x037F9784
	push {r3, r4, r5, r6, r7, lr}
	mov r7, r2
	mov r6, r0
	mov r5, r1
...
_037F9818:
	pop {r3, r4, r5, r6, r7, lr}
	bx lr
	arm_func_end sub_037F9784

	arm_func_start sub_037F9820
sub_037F9820: @ 0x037F9820
	push {r3, r4, r5, r6, r7, lr}
	mov r6, r2
	mov r7, r0
	mov r4, r1
...
_037F988C:
	pop {r3, r4, r5, r6, r7, lr}
	bx lr
	arm_func_end sub_037F9820

	arm_func_start sub_037F9894
sub_037F9894: @ 0x037F9894
	mov r1, #0
	str r1, [r0, #4]
	str r1, [r0]
	str r1, [r0, #8]
	str r1, [r0, #0xc]
	bx lr
	arm_func_end sub_037F9894

	arm_func_start sub_037F98AC
sub_037F98AC: @ 0x037F98AC
	push {r3, r4, r5, r6, r7, lr}
	mov r5, r0
	bl sub_037FAD24
...
_037F992C: .4byte 0x03806C40
	arm_func_end sub_037F98AC

	arm_func_start sub_037F9930
sub_037F9930: @ 0x037F9930
	push {r3, r4, r5, lr}
	mov r5, r0
	bl sub_037FAD24
...
_037F998C: .4byte 0x03806C40
	arm_func_end sub_037F9930

	arm_func_start sub_037F9990
sub_037F9990: @ 0x037F9990
	push {r3, r4, r5, lr}
	mov r5, r0
	mov r4, #0
	b _037F99B4
...
_037F99B4:
	...
	pop {r3, r4, r5, lr}
	bx lr
	arm_func_end sub_037F9990

	arm_func_start sub_037F99C8
sub_037F99C8: @ 0x037F99C8
	ldr r2, [r0, #0x70]
	cmp r2, #0
	streq r1, [r0, #0x6c]
	strne r1, [r2, #0x10]
	...
	str r1, [r0, #0x70]
	bx lr
	arm_func_end sub_037F99C8

	arm_func_start sub_037F99EC
sub_037F99EC: @ 0x037F99EC
	ldr r2, [r1, #0x10]
	ldr r1, [r1, #0x14]
	cmp r2, #0
	streq r1, [r0, #0x70]
...
_037FA238: .4byte sub_037F887C
_037FA23C: .4byte sub_037FA1D8
...
_037FA3C0: .4byte 0x03806DD4
	...
	arm_func_start sub_037FA3C4
sub_037FA3C4: @ 0x037FA3C4
	mov r1, #0
	str r1, [r0]
	str r1, [r0, #8]
	bx lr
	arm_func_end sub_037FA3C4
...
_037FA4FC: .4byte 0x03806DD4
	...
	arm_func_start sub_037FA500
sub_037FA500: @ 0x037FA500
	push {r3, r4, r5, r6, r7, lr}
	movs r6, r0
	mov r5, r1
	mov r4, r2
...
sub_037FAD10: @ 0x037FAD10
	...
	arm_func_start sub_037FAD24
sub_037FAD24: @ 0x037FAD24
	mrs r0, apsr
	orr r1, r0, #0x80
	msr cpsr_c, r1
	and r0, r0, #0x80
	bx lr
	arm_func_end sub_037FAD24

	arm_func_start sub_037FAD38
sub_037FAD38: @ 0x037FAD38
	mrs r1, apsr
	bic r2, r1, #0x80
	orr r2, r2, r0
	msr cpsr_c, r2
...
sub_037FAD64: @ 0x037FAD64
	...
	arm_func_start sub_037FAD7C
sub_037FAD7C: @ 0x037FAD7C
	mrs r0, apsr
	and r0, r0, #0x1f
	bx lr
	arm_func_end sub_037FAD7C
...
_037FAE90: .4byte 0x04000208
	...
	arm_func_start sub_037FAE94
sub_037FAE94: @ 0x037FAE94
	push {r3, lr}
	mov r0, #0
	bl sub_038034B0
_037FAEA0:
...
_037FAFB4:
	...
	arm_func_start sub_037FAFCC
sub_037FAFCC: @ 0x037FAFCC
	add ip, r1, r2
_037FAFD0:
	cmp r1, ip
	stmlt r1!, {r0}
...
sub_037FBF80: @ 0x037FBF80
	ldr ip, _037FBF94 @ =sub_037F96F8
	ldr r0, _037FBF98 @ =0x03806EF4
	mov r1, #1
	mov r2, #0
	bx ip
	.align 2, 0
_037FBF94: .4byte sub_037F96F8
...
_037FF664: .4byte sub_038003A8
_037FF668: .4byte 0x03808BE0
_037FF66C: .4byte sub_038002C4
...
_037FF7B4: .4byte sub_037FFA10
_037FF7B8: .4byte sub_037FF9D0
...
_038032B8: .4byte sub_0380343C
_038032BC: .4byte sub_0380346C
_038032C0: .4byte sub_038034A0
_038032C4: .4byte sub_038037E4
...
_038047C4: .4byte sub_038047DC
_038047C8: .4byte 0x038094F0
_038047CC: .4byte 0x03809500
_038047D0: .4byte sub_03804958
_038047D4: .4byte 0x038096A4
_038047D8: .4byte sub_03804DD8
...
_03805A34: .4byte sub_03805BC8
_03805A38: .4byte sub_03805B18
...
_03805D5C: .4byte sub_03805D6C
_03805D60: .4byte 0x03809EF8
_03805D64: .4byte sub_03805B18
_03805D68: .4byte sub_03805DDC
...
_03806238:
	...
	arm_func_start sub_0380625C
sub_0380625C: @ 0x0380625C
	eor ip, r0, r1
