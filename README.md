...
This is a WIP decompilation of Pokemon HeartGold and SoulSilver. For instructions on how to set up the repository, please read [INSTALL.md](docs/INSTALL.md).
