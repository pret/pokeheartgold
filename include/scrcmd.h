...
BOOL ScrCmd_176(SCRIPTCONTEXT* ctx);
...
BOOL ScrCmd_240(SCRIPTCONTEXT* ctx);
BOOL ScrCmd_241(SCRIPTCONTEXT* ctx);
BOOL ScrCmd_242(SCRIPTCONTEXT* ctx);
...
BOOL ScrCmd_447(SCRIPTCONTEXT* ctx);
...
BOOL ScrCmd_488(SCRIPTCONTEXT* ctx);
