...
FRONTIER_SAVE *Save_Frontier_GetStatic(SaveData *saveData);
void Save_Frontier_Load(SaveData *saveData);
int FrontierSave_GetStat(FRONTIER_SAVE *, int, int);
void Save_Frontier_Commit(SaveData *saveData);
u32 sub_02031108(FRONTIER_SAVE *, int, int, u16);
void sub_0203126C(FRONTIER_SAVE *a0, u32 a1, u32 a2, u16 a3);
