...
void FieldMessage_LoadTextPalettes(int palLocation, BOOL resetPrinters);
void sub_0205B514(BgConfig *bgConfig, Window *window, int arg2);
...
u32 sub_0205B5EC(Window *window, String *message, FontID fontId, u32 textFrame, u8 speedUpEnabled, u32 arg5);
