...
void thunk_Sprite_SetAffineZRotation(Sprite *sprite, u32 a1);
void ManagedSprite_SetAffineZRotation(ManagedSprite *managedSprite, u16 a1);
void Sprite_OffsetAffineZRotation2(Sprite *sprite, u32 a1);
void ManagedSprite_OffsetAffineZRotation(ManagedSprite *managedSprite, u32 a1);
