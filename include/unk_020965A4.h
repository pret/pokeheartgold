...
void FrontierSystem_SetData(void *a0, u32 a1);
void *FrontierSystem_GetData(void *a0);
void FrontierSystem_LaunchApplication(void *a0, const OVY_MGR_TEMPLATE *ovyTemp, void *args, u32 a3, UnkFuncPtr_020965A4 func);
