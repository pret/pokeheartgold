...
BOOL sub_0205A478(struct UnkStruct_02059E1C *fsys_unk80);
BOOL sub_0205A4D8(struct UnkStruct_02059E1C *fsys_unk80);
int sub_0205A6AC(MessageFormat *msgFmt);
int sub_0205A750(struct UnkStruct_02059E1C *fsys_unk80, int objId, int a2, MessageFormat *msgFmt);
