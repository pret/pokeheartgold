...
// When checking your party against battle rules, the flag that bans Soul Dew uses the most significant bit of the total party level, however this is incorrectly checked. Uncomment this to use the intended behavior.
