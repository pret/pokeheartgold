...
#define BATTLE_TYPE_CAN_LOSE      (1 << 11)
#define BATTLE_TYPE_BUG_CONTEST   (1 << 12)
#define BATTLE_TYPE_TRAINER_HOUSE (1 << 13)
...
#define BATTLE_TYPE_FRONTIER_SINGLES         (BATTLE_TYPE_FRONTIER | BATTLE_TYPE_TRAINER)
...
#define BATTLE_TYPE_AI_PARTNER               (BATTLE_TYPE_DOUBLES | BATTLE_TYPE_MULTI | BATTLE_TYPE_AI)
...
#define BATTLE_TYPE_SPECIAL_WILD             (BATTLE_TYPE_SAFARI | BATTLE_TYPE_ROAMER | BATTLE_TYPE_PAL_PARK | BATTLE_TYPE_TUTORIAL)
...
#define BATTLE_TYPE_MULTI_TAG                (BATTLE_TYPE_MULTI | BATTLE_TYPE_TAG)
#define BATTLE_TYPE_ALWAYS_CATCH             (BATTLE_TYPE_PAL_PARK | BATTLE_TYPE_TUTORIAL)
...
#define MOVE_STATUS_DID_NOT_AFFECT      (MOVE_STATUS_NO_EFFECT | MOVE_STATUS_WONDER_GUARD_IMMUNE)
#define MOVE_STATUS_IMMUNE              (MOVE_STATUS_DID_NOT_AFFECT | MOVE_STATUS_LEVITATE_IMMUNE | MOVE_STATUS_MAGNET_RISE_IMMUNE)
...
#define STATUS2_TRAPPED        (STATUS2_BIND | STATUS2_MEAN_LOOK)
