...
typedef struct FrontierFieldSystem {
    ...
    u8 filler83d;
    u16 unk83e[0x23]; // Related to unk10_3 somehow. Also player gender? Also species??? these seem to be some sort of struct?
    u16 unk884[0x23]; // Seemingly never set. Probably relates to tag partner somehow.
    u8 filler8CA[0xa];
    u8 unk8D4;
    u8 unk8D5;
    u8 filler8D6[2];
