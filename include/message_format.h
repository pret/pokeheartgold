...
void BufferString(MessageFormat *messageFormat, u32 fieldno, String *string, s32 a3, s32 a4, s32 a5);
void BufferIntegerAsString(MessageFormat *messageFormat, u32 idx, s32 num, u32 numDigits, enum PaddingMode paddingMode, BOOL whichCharset);
...
void SetStringAsPlaceholder(MessageFormat *messageFormat, u32 fieldno, String *string, const MessageFormatAttrs *attrs);
