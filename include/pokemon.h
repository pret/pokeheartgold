...
int GetMonBaseStat_HandleAlternateForm(int species, int form, BaseStat stat_id);
...
struct UnkImageStruct *sub_02070C24(SpriteRenderer *r6, SpriteGfxHandler *sp18, PaletteData *sp1C, int sp20, int sp88, int trainerClass, int sp90, int sp94, int r5, HeapID heapId);
