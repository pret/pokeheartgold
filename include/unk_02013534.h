...
UnkStruct_02013534 *sub_02013534(int num, HeapID heapID);
...
UnkStruct_02013910 *sub_02013910(Window *window, HeapID heapID);
...
void TextOBJ_CopyFromBGWindow(TextOBJ *textOBJ, UnkStruct_02013910 *a1, Window *window, HeapID heapID);
