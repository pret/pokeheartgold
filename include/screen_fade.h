...
enum FadeType {
    ...
    FADE_TYPE_UNK_5, // Used in intro movie scene 5. Possibly UPWARD_IN?
    FADE_TYPE_UNK_6,
    FADE_TYPE_UNK_7,
    FADE_TYPE_UNK_8, // Used for camera shutter out. May be FADE_TYPE_CIRCLE_OUT from pokeplatinum. TODO: Check in-game.
    FADE_TYPE_UNK_9, // Used for camera shutter in. TODO: Same deal as above.
