...
static void LoadBgGraphics(CreditsAppWork *work) {
    ...
    GfGfxLoader_GXLoadPal(NARC_a_2_6_3, 4, GF_PAL_LOCATION_SUB_BG, GF_PAL_SLOT_OFFSET_0, 0xe0, HEAP_ID_CREDITS);
    GfGfxLoader_GXLoadPal(NARC_a_2_6_3, 4, GF_PAL_LOCATION_MAIN_BG, GF_PAL_SLOT_OFFSET_0, 0xe0, HEAP_ID_CREDITS);
    for (u8 i = 0; i < 6; i++) {
...
static void DisplayWindow(CreditsAppWork *work) {
    ...
    LoadFontPal0(GF_PAL_LOCATION_SUB_BG, GF_PAL_SLOT_OFFSET_15, HEAP_ID_CREDITS);
