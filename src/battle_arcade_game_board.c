...
static void BattleArcadeGameBoard_InitObjects(GAME_BOARD_WORK *work) {
    ...
    LoadFontPal0(GF_PAL_LOCATION_MAIN_BG, GF_PAL_SLOT_OFFSET_13, HEAP_ID_GAME_BOARD);
    LoadFontPal1(GF_PAL_LOCATION_MAIN_BG, GF_PAL_SLOT_OFFSET_12, HEAP_ID_GAME_BOARD);
...
static void ov84_0223EB78(GAME_BOARD_WORK *work, enum GFBgLayer layer) {
    ...
    GfGfxLoader_GXLoadPalFromOpenNarc(work->narc, 187, GF_PAL_LOCATION_SUB_BG, GF_PAL_SLOT_OFFSET_0, 0x40, HEAP_ID_GAME_BOARD);
