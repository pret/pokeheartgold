...
void LegendCutscene_BeginClearBellAnim(FieldSystem *fieldSystem) {
    ...
    fieldSystem->unk4->legendCutsceneCamera = AllocFromHeapAtEnd(HEAP_ID_FIELD1, sizeof(ClearBellCutsceneCamera));
...
void LegendCutscene_LugiaEyeGlimmerEffect(FieldSystem *fieldSystem) {
    LegendCutsceneLugiaEyeGlimmerTaskData *eyeGlimmer = AllocFromHeapAtEnd(HEAP_ID_FIELD1, sizeof(LegendCutsceneLugiaEyeGlimmerTaskData));
...
static void Field3dObjectTaskInit_ClearBellCutscene(Field3dObjectTask *task, FieldSystem *fieldSystem, void *taskData) {
    ...
    GF_ExpHeap_FndInitAllocator(&kimonoDanceObjData->allocator, HEAP_ID_FIELD1, 0x20);
...
void LegendCutscene_BirdFinalApproach(FieldSystem *fieldSystem) {
    BirdFinalApproachTaskData *taskData = AllocFromHeapAtEnd(HEAP_ID_FIELD1, sizeof(BirdFinalApproachTaskData));
...
static BOOL Task_BirdFinalApproach(TaskManager *taskman) {
    ...
    case BIRD_FINAL_APPROACH_TASK_STATE_INIT:
        GF_ExpHeap_FndInitAllocator(&taskData->allocator, HEAP_ID_FIELD1, 0x20);
...
void LegendCutscene_BeginLugiaArrivesEffect(FieldSystem *fieldSystem) {
    ...
    fieldSystem->unk4->legendCutsceneCamera = AllocFromHeapAtEnd(HEAP_ID_FIELD1, sizeof(LugiaArrivesCutsceneCamera));
    cam = fieldSystem->unk4->legendCutsceneCamera;
