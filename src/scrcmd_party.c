...
BOOL ScrCmd_GetPartyMonSpecies(ScriptContext *ctx) {
    ...
    Pokemon *mon = Party_GetMonByIndex(SaveArray_Party_Get(fsys->savedata), slot);
...
BOOL ScrCmd_SetMonMove(ScriptContext *ctx) {
    ...
    PartyMonSetMoveInSlot(SaveArray_Party_Get(ctx->fsys->savedata), monSlot, moveSlot, moveId);
...
BOOL ScrCmd_GetPartySlotWithMove(ScriptContext *ctx) {
    ...
    u8 partyCount = Party_GetCount(SaveArray_Party_Get(fsys->savedata));
...
BOOL ScrCmd_Party_GetCount(ScriptContext *ctx) {
    ...
    *count = Party_GetCount(SaveArray_Party_Get(fsys->savedata));
    return FALSE;
}
...
BOOL ScrCmd_PartyCountNotEgg(ScriptContext *ctx) {
    ...
    int partyCount = Party_GetCount(SaveArray_Party_Get(fsys->savedata));
...
BOOL ScrCmd_MonForgetMove(ScriptContext *ctx) {
    ...
    Pokemon *mon = Party_GetMonByIndex(SaveArray_Party_Get(fsys->savedata), pokemonSlot);
...
BOOL ScrCmd_GetPartyRibbonCount(ScriptContext *ctx) {
    ...
    u16 *ribbons = ScriptGetVarPointer(ctx);
    u16 partyCount = Party_GetCount(SaveArray_Party_Get(ctx->fsys->savedata));
    party = SaveArray_Party_Get(ctx->fsys->savedata);
...
BOOL ScrCmd_MonAddContestValue(ScriptContext *ctx) {
    ...
    mon = Party_GetMonByIndex(SaveArray_Party_Get(ctx->fsys->savedata), slot);
