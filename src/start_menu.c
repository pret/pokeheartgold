...
static StartMenuTaskData *StartMenu_Create(void) {
    StartMenuTaskData *ret = AllocFromHeap(HEAP_ID_FIELD2, sizeof(StartMenuTaskData));
...
static BOOL Task_StartMenu_OpenPokedex(TaskManager *taskManager) {
    ...
    PokedexArgs *pokedexArgs = AllocFromHeap(HEAP_ID_FIELD2, sizeof(PokedexArgs));
...
static BOOL Task_StartMenu_HandleReturn_Pokedex(TaskManager *taskManager) {
    ...
    if (startMenu->exitTaskEnvironment != NULL) {
        FreeToHeapExplicit(HEAP_ID_FIELD2, startMenu->exitTaskEnvironment);
    }
...
BOOL Task_StartMenu_HandleReturn_Pokemon(TaskManager *taskManager) {
    ...
    PartyMenuArgs *partyMenuArgs = AllocFromHeap(HEAP_ID_FIELD2, sizeof(PartyMenuArgs));
    ...
    case PARTY_MENU_ACTION_RETURN_1: {
        PokemonSummaryArgs *pokemonSummaryArgs = AllocFromHeap(HEAP_ID_FIELD2, sizeof(PokemonSummaryArgs));
    ...
    case PARTY_MENU_ACTION_RETURN_4: {
        ...
        sub_0208AD34(pokemonSummaryArgs, Save_PlayerData_GetProfile(fieldSystem->saveData));
        PokemonSummary_LearnForget_LaunchApp(fieldSystem, pokemonSummaryArgs);
        UnkStruct_0203D580 *unk = AllocFromHeap(HEAP_ID_FIELD2, sizeof(UnkStruct_0203D580));
    ...
    case PARTY_MENU_ACTION_RETURN_READ_MAIL:
        ...
        break;
    case 3: {
        StartMenuAfterEvoPartySlotBak *afterEvoPartySlot = AllocFromHeap(HEAP_ID_FIELD2, sizeof(StartMenuAfterEvoPartySlotBak));
    ...
    case PARTY_MENU_ACTION_RETURN_EVO_ITEM_USE: {
        UnkStruct_0203CA9C_Case8 *unk = AllocFromHeap(HEAP_ID_FIELD2, sizeof(UnkStruct_0203CA9C_Case8));
...
static BOOL sub_0203D580(TaskManager *taskManager) {
    ...
    PokemonSummaryArgs *summaryArgs = AllocFromHeap(HEAP_ID_FIELD2, sizeof(PokemonSummaryArgs));
...
BOOL Task_UseFlyInField(TaskManager *taskManager) {
    ...
    FreeToHeapExplicit(HEAP_ID_FIELD2, flyMap);
    PokegearArgs *pokegearArgs = startMenu->exitTaskEnvironment;
    if (!pokegearArgs->unk_14) {
        FreeToHeapExplicit(HEAP_ID_FIELD2, pokegearArgs);
        ...
        struct UnkStruct_02067BF8 *r5 = sub_02067BF8(HEAP_ID_FIELD2, fieldSystem, pokemon, partySlot, pokegearArgs->unk_20, pokegearArgs->mapCursorX * 32 + 0x10, pokegearArgs->mapCursorY * 32 + 0x10);
        FreeToHeapExplicit(HEAP_ID_FIELD2, startMenu->exitTaskEnvironment);
        FieldSystem_LoadFieldOverlay(fieldSystem);
...
UnkStruct_0203D818 *sub_0203D818(u16 itemId, u8 kind, u8 partySlot) {
    UnkStruct_0203D818 *ret = AllocFromHeap(HEAP_ID_FIELD2, sizeof(UnkStruct_0203D818));
    ret->itemId = itemId;
...
static void Task_StartMenu_Evolution(TaskManager *taskManager) {
    ...
    StartMenuAfterEvoPartySlotBak *newEnv = AllocFromHeap(HEAP_ID_FIELD2, sizeof(StartMenuAfterEvoPartySlotBak));
