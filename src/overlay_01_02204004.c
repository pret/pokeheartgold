...
static struct UnkStruct_ov01_02204004_sub *ov01_02204168(struct UnkStruct_ov01_02204004 *mgr, const NNSG3dResFileHeader **header, int fileId);
static BOOL ov01_02204144(struct UnkStruct_ov01_02204004 *mgr, int fileId);

struct UnkStruct_ov01_02204004 *ov01_02204004(HeapID heapId, int nmax, int a2, NNSG3dResFileHeader **modelFileHeaders) {
    struct UnkStruct_ov01_02204004 *ret = AllocFromHeap(heapId, sizeof(struct UnkStruct_ov01_02204004));
    int i;
    ...
    ret->unk8 = AllocFromHeap(heapId, a2 * sizeof(struct UnkStruct_ov01_02204004_sub));
    MI_CpuClearFast(ret->unk8, a2 * sizeof(struct UnkStruct_ov01_02204004_sub));
    ret->unkC = AllocFromHeap(heapId, a2 * sizeof(struct UnkStruct_ov01_02204004_sub *));
    for (i = 0; i < a2; i++) {
...
static struct UnkStruct_ov01_02204004_sub *ov01_02204168(struct UnkStruct_ov01_02204004 *mgr, const NNSG3dResFileHeader **header, int fileId) {
    struct UnkStruct_ov01_02204004_sub *ret;
