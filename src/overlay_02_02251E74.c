...
extern const u32 ov02_02253CF8[2][2];
extern const u32 ov02_02253D14[2][2];
...
void SinjohCutscene_LoadResources(SinjohCutsceneData *data) {
    ...
    u32 unkData2[2];
    u32 unkData3[2];
    unkData2 = ov02_02253CF8[0];
    unkData3 = ov02_02253CF8[1];
...
extern const u32 ov02_02253D08[3];
extern const u32 ov02_02253D24[3][4];
