...
static void PokegearPhone_LaunchApp_Impl(FieldSystem *fieldSystem, PokegearArgs *args) {
    static const OverlayManagerTemplate sOverlayTemplate_Phone = { Phone_Init, Phone_Main, Phone_Exit, FS_OVERLAY_ID(OVY_100) };
    OverlayManagerTemplate template = sOverlayTemplate_Phone;
    FieldSystem_LaunchApplication(fieldSystem, &template, args);
}
