...
void FieldSystem_LaunchTask_ViewRankingsApp(FieldSystem *fieldSystem, u8 pageScrollParam, u8 cursorPos) {
    UnkStruct_02097D48 *taskData = AllocFromHeapAtEnd(HEAP_ID_FIELD2, sizeof(UnkStruct_02097D48));
    taskData->state = 0;
    taskData->args = AllocFromHeapAtEnd(HEAP_ID_FIELD2, sizeof(ViewRankingsArgs));
