...
static void sub_0204FB20(TaskManager *taskManager, u16 firstMon, u16 secondMon, u16 *result) {
    UnkStruct_0204FB20 *unk = AllocFromHeap(HEAP_ID_FIELDMAP, sizeof(UnkStruct_0204FB20));
...
static void sub_0204FBDC(TaskManager *taskManager, void *a1, BattleCastleChallengeType challengeType) {
    ...
    UnkStruct_0204FBDC *unk = AllocFromHeap(HEAP_ID_FIELDMAP, sizeof(UnkStruct_0204FBDC));
...
static BOOL sub_0204FC10(TaskManager *taskManager) {
    ...
    switch (unk->state) {
    case 0:
        unk->state = sub_0204FC78(unk, fieldSystem, HEAP_ID_FIELDMAP);
        break;
    case 1:
        unk->state = sub_0204FD50(unk, fieldSystem);
        break;
    case 2:
        unk->state = sub_0204FDA0(unk, fieldSystem, HEAP_ID_FIELDMAP);
        break;
    case 3:
...
static u32 sub_0204FC78(UnkStruct_0204FBDC *a0, FieldSystem *fieldSystem, HeapID unused) {
    PartyMenuArgs *partyMenu = AllocFromHeap(HEAP_ID_FIELDMAP, sizeof(PartyMenuArgs));
