...
BOOL MonIsFromTogepiEgg(Pokemon *mon, SaveData *saveData) {
    ...
    u8 byte = Pokemon_GetData(mon, MON_DATA_MET_GENDER, NULL);
...
static BOOL MonIsInGameTradePokeInternal(Pokemon *mon, NPCTrade *trade, NpcTradeNum tradeNum) {
    ...
    u8 gender = Pokemon_GetData(mon, MON_DATA_MET_GENDER, NULL);
    ...
    Pokemon_GetData(mon, MON_DATA_OT_NAME_2, monOtName);
