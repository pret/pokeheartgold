...
#include "files/msgdata/msg/msg_0021.h"
#include "files/msgdata/msg/msg_0040.h"
#include "files/msgdata/msg/msg_0191.h"
#include "files/msgdata/msg/msg_0274.h"
#include "files/msgdata/msg/msg_0313.h"
#include "files/msgdata/msg/msg_0428.h"
#include "files/msgdata/msg/msg_0430.h"
...
void BufferFriendsName(MessageFormat *msgFmt, u32 fieldno, SaveData *saveData) {
    ...
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0445, msgFmt->heapID);
...
void BufferSpeciesName(MessageFormat *msgFmt, u32 fieldno, u16 species) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0237, msgFmt->heapID);
...
void BufferSpeciesNameWithArticle(MessageFormat *msgFmt, u32 fieldno, u32 species) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0238, msgFmt->heapID);
    ReadMsgDataIntoString(msgData, species, msgFmt->buffer);
    SetStringAsPlaceholder(msgFmt, fieldno, msgFmt->buffer, NULL);
    DestroyMsgData(msgData);
}
...
void BufferMoveName(MessageFormat *msgFmt, u32 fieldno, u32 moveId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0750, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferRibbonNameOrDesc(MessageFormat *msgFmt, u32 fieldno, u32 decoId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0424, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferAbilityName(MessageFormat *msgFmt, u32 fieldno, u32 abilityId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0720, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferNatureName(MessageFormat *msgFmt, u32 fieldno, u32 natureId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0034, msgFmt->heapID);
...
void BufferItemName(MessageFormat *msgFmt, u32 fieldno, u32 itemId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0222, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferItemNameWithIndefArticle(MessageFormat *msgFmt, u32 fieldno, u32 itemId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0223, msgFmt->heapID);
    if (msgData != NULL) {
        ReadMsgDataIntoString(msgData, itemId, msgFmt->buffer);
        SetStringAsPlaceholder(msgFmt, fieldno, msgFmt->buffer, NULL);
        DestroyMsgData(msgData);
...
void BufferItemNamePlural(MessageFormat *msgFmt, u32 fieldno, u32 itemId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0224, msgFmt->heapID);
    if (msgData != NULL) {
        ReadMsgDataIntoString(msgData, itemId, msgFmt->buffer);
        SetStringAsPlaceholder(msgFmt, fieldno, msgFmt->buffer, NULL);
        DestroyMsgData(msgData);
...
void BufferPocketName(MessageFormat *msgFmt, u32 fieldno, u32 pocketId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0226, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferTypeName(MessageFormat *msgFmt, u32 fieldno, u32 typeId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0735, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferStatName(MessageFormat *msgFmt, u32 fieldno, u32 statId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0443, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferStatusName(MessageFormat *msgFmt, u32 fieldno, u32 statusId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0044, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferFlavorDislikeText(MessageFormat *msgFmt, u32 fieldno, u32 flavorId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0639, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferLandmarkName(MessageFormat *msgFmt, u32 fieldno, u32 landmarkId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0279, msgFmt->heapID);
    if (msgData != NULL) {
        if (landmarkId == 0 || landmarkId >= MsgDataGetCount(msgData)) {
            DestroyMsgData(msgData);
            msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0280, msgFmt->heapID);
            landmarkId = 2;
        }
...
void BufferTrainerClassName(MessageFormat *msgFmt, u32 fieldno, u32 trainerClassId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0730, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferTrainerClassNameWithArticle(MessageFormat *msgFmt, u32 fieldno, u32 trainerClassId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0731, msgFmt->heapID);
    if (msgData != NULL) {
        ReadMsgDataIntoString(msgData, trainerClassId, msgFmt->buffer);
        SetStringAsPlaceholder(msgFmt, fieldno, msgFmt->buffer, NULL);
        DestroyMsgData(msgData);
...
void BufferTrainerName(MessageFormat *msgFmt, u32 fieldno, u32 trainerId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0729, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferFrontierOpponentName(MessageFormat *msgFmt, u32 fieldno, u32 opponentId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0027, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferDecorationName(MessageFormat *msgFmt, u32 fieldno, u32 decorationId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0737, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferGenderSymbol(MessageFormat *msgFmt, u32 fieldno, u8 gender) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0040, msgFmt->heapID);
    switch (gender) {
...
void BufferCountryName(MessageFormat *msgFmt, u32 fieldno, u32 countryId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0798, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferSealName(MessageFormat *msgFmt, u32 fieldno, u32 sealId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0015, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferSealNamePlural(MessageFormat *msgFmt, u32 fieldno, u32 sealId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0016, msgFmt->heapID);
    if (msgData != NULL) {
        ReadMsgDataIntoString(msgData, sealId, msgFmt->buffer);
        SetStringAsPlaceholder(msgFmt, fieldno, msgFmt->buffer, NULL);
        DestroyMsgData(msgData);
...
void BufferFashionName(MessageFormat *msgFmt, u32 fieldno, u32 fashionId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0216, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferFashionNameWithArticle(MessageFormat *msgFmt, u32 fieldno, u32 fashionId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0217, msgFmt->heapID);
    if (msgData != NULL) {
        ReadMsgDataIntoString(msgData, fashionId, msgFmt->buffer);
        SetStringAsPlaceholder(msgFmt, fieldno, msgFmt->buffer, NULL);
        DestroyMsgData(msgData);
...
void BufferContestBackgroundName(MessageFormat *msgFmt, u32 fieldno, u32 bgId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0218, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferWiFiPlazaActivityName(MessageFormat *msgFmt, u32 fieldno, u32 activityId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0755, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferWiFiPlazaEventName(MessageFormat *msgFmt, u32 fieldno, u32 eventId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0753, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferWiFiPlazaInstrumentName(MessageFormat *msgFmt, u32 fieldno, u32 instrumentId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0756, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferJPGreeting(MessageFormat *msgFmt, u32 fieldno, u32 timeOfDay) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0771, msgFmt->heapID);
    if (msgData != NULL) {
...
void BufferENGreeting(MessageFormat *msgFmt, u32 fieldno, u32 timeOfDay) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0767, msgFmt->heapID);
    if (msgData != NULL) {
        ReadMsgDataIntoString(msgData, timeOfDay, msgFmt->buffer);
        SetStringAsPlaceholder(msgFmt, fieldno, msgFmt->buffer, NULL);
        DestroyMsgData(msgData);
...
void BufferFRGreeting(MessageFormat *msgFmt, u32 fieldno, u32 timeOfDay) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0768, msgFmt->heapID);
    if (msgData != NULL) {
        ReadMsgDataIntoString(msgData, timeOfDay, msgFmt->buffer);
        SetStringAsPlaceholder(msgFmt, fieldno, msgFmt->buffer, NULL);
        DestroyMsgData(msgData);
...
void BufferITGreeting(MessageFormat *msgFmt, u32 fieldno, u32 timeOfDay) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0770, msgFmt->heapID);
    if (msgData != NULL) {
        ReadMsgDataIntoString(msgData, timeOfDay, msgFmt->buffer);
        SetStringAsPlaceholder(msgFmt, fieldno, msgFmt->buffer, NULL);
        DestroyMsgData(msgData);
...
void BufferDEGreeting(MessageFormat *msgFmt, u32 fieldno, u32 timeOfDay) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0769, msgFmt->heapID);
    if (msgData != NULL) {
        ReadMsgDataIntoString(msgData, timeOfDay, msgFmt->buffer);
        SetStringAsPlaceholder(msgFmt, fieldno, msgFmt->buffer, NULL);
        DestroyMsgData(msgData);
...
void BufferSPGreeting(MessageFormat *msgFmt, u32 fieldno, u32 timeOfDay) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0772, msgFmt->heapID);
    if (msgData != NULL) {
        ReadMsgDataIntoString(msgData, timeOfDay, msgFmt->buffer);
        SetStringAsPlaceholder(msgFmt, fieldno, msgFmt->buffer, NULL);
        DestroyMsgData(msgData);
...
void BufferPokeathlonCourseName(MessageFormat *msgFmt, u32 fieldno, u32 courseId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0313, msgFmt->heapID);
...
void BufferApricornName(MessageFormat *msgFmt, u32 fieldno, u32 apricornId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0021, msgFmt->heapID);
    if (apricornId >= 7) {
...
void BufferSafariZoneObjectName(MessageFormat *msgFmt, u32 fieldno, u32 objectId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0430, msgFmt->heapID);
    if (objectId >= 24) {
...
void BufferSafariZoneAreaName(MessageFormat *msgFmt, u32 fieldno, u32 areaId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0428, msgFmt->heapID);
    if (areaId >= 12) {
        GF_ASSERT(areaId < 12);
        areaId = 0;
    }
...
void BufferPokewalkerCourseName(MessageFormat *msgFmt, u32 fieldno, u32 courseId) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0274, msgFmt->heapID);
    if (courseId >= 27) {
...
void BufferMonthNameAbbr(MessageFormat *msgFmt, u32 fieldno, u32 month) {
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0239, msgFmt->heapID);
    if (msgData != NULL) {
        if (month < 1 || month > 12) {
            month = 1;
        }
...
void BufferDeptStoreFloorNo(MessageFormat *msgFmt, u32 fieldno, u32 floor) {
    s32 msgno;
    MsgData *msgData = NewMsgDataFromNarc(MSGDATA_LOAD_LAZY, NARC_msgdata_msg, msg_0191, msgFmt->heapID);
    GF_ASSERT(floor <= 6);
    if (msgData != NULL) {
        if (floor == 0) {
