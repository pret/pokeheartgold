...
void sub_0206B910(TaskManager *taskManager, SaveData *saveData) {
    ...
    UnkStruct_0206B910 *r4 = Heap_AllocAtEnd(HEAP_ID_FIELD, sizeof(UnkStruct_0206B910));
    memset(r4, 0, sizeof(UnkStruct_0206B910));
    r4->saveData = saveData;
    r4->unk04 = Heap_Alloc(HEAP_ID_FIELD, sizeof(UnkStruct_0206B984));
    ...
    r4->partyMenu = Heap_Alloc(HEAP_ID_FIELD, sizeof(PartyMenuArgs));
...
static UnkStruct_0206BCD4 *sub_0206BCEC(UnkStruct_0206BCEC *unused) {
    Heap_Create(HEAP_ID_FIELD, HEAP_ID_20, 0x4000);
    return sub_0206BCD4();
}
