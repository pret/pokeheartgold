...
static const SafariObjectConfig sObjects[NUM_SAFARI_ZONE_OBJECT_IDS] = {
    [SAFARI_ZONE_OBJECTID_SHRUBBERY]    = { BUILD_MODEL_SAF_GO01,  FALSE, 1, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_PLAINS },
    [SAFARI_ZONE_OBJECTID_RED_FLOWER]   = { BUILD_MODEL_SAF_GO02,  FALSE, 1, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_PLAINS },
    [SAFARI_ZONE_OBJECTID_WHITE_FLOWER] = { BUILD_MODEL_SAF_GO03,  FALSE, 1, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_PLAINS },
    [SAFARI_ZONE_OBJECTID_TREE]         = { BUILD_MODEL_SAF_TO01,  FALSE, 2, 2, FALSE, SAFARI_ZONE_OBJECT_TYPE_FOREST },
    [SAFARI_ZONE_OBJECTID_STUMP]        = { BUILD_MODEL_SAF_TO02,  FALSE, 2, 2, FALSE, SAFARI_ZONE_OBJECT_TYPE_FOREST },
    [SAFARI_ZONE_OBJECTID_BRANCHES]     = { BUILD_MODEL_SAF_TO03,  FALSE, 2, 2, FALSE, SAFARI_ZONE_OBJECT_TYPE_FOREST },
    [SAFARI_ZONE_OBJECTID_SMALL_ROCK]   = { BUILD_MODEL_SAF_RO01,  FALSE, 1, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_PEAK   },
    [SAFARI_ZONE_OBJECTID_BIG_ROCK]     = { BUILD_MODEL_SAF_RO02,  FALSE, 2, 2, FALSE, SAFARI_ZONE_OBJECT_TYPE_PEAK   },
    [SAFARI_ZONE_OBJECTID_MOSSY_ROCK]   = { BUILD_MODEL_SAF_RO03,  FALSE, 2, 2, FALSE, SAFARI_ZONE_OBJECT_TYPE_PEAK   },
    [SAFARI_ZONE_OBJECTID_PUDDLE]       = { BUILD_MODEL_SAF_WO01,  FALSE, 2, 2, FALSE, SAFARI_ZONE_OBJECT_TYPE_WATER  },
    ...
    [SAFARI_ZONE_OBJECTID_BENCH]        = { BUILD_MODEL_SAF_EO01,  FALSE, 2, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_NONE   },
    [SAFARI_ZONE_OBJECTID_SHORT_FENCE1] = { BUILD_MODEL_SAF_EO02,  FALSE, 1, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_NONE   },
    [SAFARI_ZONE_OBJECTID_SHORT_FENCE2] = { BUILD_MODEL_SAF_EO03,  FALSE, 1, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_NONE   },
    [SAFARI_ZONE_OBJECTID_LONG_FENCE1]  = { BUILD_MODEL_SAF_EO04,  FALSE, 2, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_NONE   },
    [SAFARI_ZONE_OBJECTID_LONG_FENCE2]  = { BUILD_MODEL_SAF_EO05,  FALSE, 1, 2, FALSE, SAFARI_ZONE_OBJECT_TYPE_NONE   },
    [SAFARI_ZONE_OBJECTID_SIGNBOARD]    = { BUILD_MODEL_SAF_EO06,  FALSE, 1, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_NONE   },
    [SAFARI_ZONE_OBJECTID_YOUR_STATUE]  = { BUILD_MODEL_SAF_EO07M, FALSE, 1, 1, TRUE,  SAFARI_ZONE_OBJECT_TYPE_NONE   },
    [SAFARI_ZONE_OBJECTID_YOUR_FLAG]    = { BUILD_MODEL_SAF_EO08M, FALSE, 1, 1, TRUE,  SAFARI_ZONE_OBJECT_TYPE_NONE   },
    [SAFARI_ZONE_OBJECTID_OUTSIDE_LAMP] = { BUILD_MODEL_SAF_EO09,  FALSE, 1, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_NONE   },
    [SAFARI_ZONE_OBJECTID_GUIDEPOST_R_] = { BUILD_MODEL_SAF_EO10,  FALSE, 1, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_NONE   },
    [SAFARI_ZONE_OBJECTID_GUIDEPOST_L_] = { BUILD_MODEL_SAF_EO11,  FALSE, 1, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_NONE   },
    [SAFARI_ZONE_OBJECTID_TRASH_CAN]    = { BUILD_MODEL_SAF_EO12,  FALSE, 1, 1, FALSE, SAFARI_ZONE_OBJECT_TYPE_NONE   },
};
// clang-format on
...
void GetSafariObjectConfig(SafariObjectConfig *dest, int idx, int gender) {
    ...
    *dest = sObjects[idx];
    if (dest->hasGenderedLayout && gender == TRAINER_FEMALE) {
        // BUILD_MODEL_SAF_EO07M --> BUILD_MODEL_SAF_EO07F
        // BUILD_MODEL_SAF_EO08M --> BUILD_MODEL_SAF_EO08F
        ++dest->buildModel;
    }
}
