...
BOOL ScrCmd_643(ScriptContext *ctx) {
    ...
    sub_02030E88(ctx->fsys->savedata);
    void *unk0 = sub_02030FA0(ctx->fsys->savedata);
    ...
    switch (arg0) {
        ...
        case 1: // Unused
            if (arg1 == 3) {
                *result = sub_020310BC(sub_0203107C(ctx->fsys->savedata), 110, sub_0205C268(110));
            } else {
                *result = sub_02030FE4(unk0, 8, arg1, 0, 0);
            }
            break;
        case 3: // Unused
            sub_0204FFB0(ctx->fsys->savedata, unk0, arg1);
            break;
        case 4:
...
BOOL ScrCmd_646(ScriptContext *ctx) {
    ...
    sub_0204FFB0(ctx->fsys->savedata, sub_02030FA0(ctx->fsys->savedata), unk);
    return FALSE;
}
...
static void sub_0205011C(TaskManager *taskManager, void *a1, BattleArcadeChallengeType challengeType) {
    ...
    unk->unk0c = a1;
    TaskManager_Call(fsys->taskman, sub_02050150, unk);
}
...
static BOOL sub_02050150(TaskManager *taskManager) {
    ...
    switch (unk->state) {
        case 0:
            unk->state = sub_020501B8(unk, fsys, HEAP_ID_FIELD);
            break;
        case 1:
            unk->state = sub_02050290(unk, fsys);
            break;
        case 2:
            unk->state = sub_020502E0(unk, fsys, HEAP_ID_FIELD);
            break;
        case 3:
            unk->state = sub_02050370(unk, fsys);
            break;
        case 4:
            FreeToHeap(unk);
            return TRUE;
...
static u32 sub_020501B8(UnkStruct_0204FBDC *a0, FieldSystem *fsys, u32 a2) {
...
static u32 sub_02050290(UnkStruct_0204FBDC *a0, FieldSystem *fsys) {
...
static u32 sub_020502E0(UnkStruct_0204FBDC *a0, FieldSystem *fsys, HeapID heapId) {
...
static u32 sub_02050370(UnkStruct_0204FBDC *a0, FieldSystem *fsys) {
    if (FieldSys_ApplicationIsRunning(fsys)) {
        return 3;
    }
