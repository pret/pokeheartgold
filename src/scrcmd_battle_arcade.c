...
static void sub_02050060(TaskManager *taskManager, u16 firstMon, u16 secondMon, u16 *result) {
    UnkStruct_02050060 *unk = AllocFromHeap(HEAP_ID_FIELDMAP, sizeof(UnkStruct_02050060));
...
static BOOL sub_02050150(TaskManager *taskManager) {
    ...
    switch (unk->state) {
    case 0:
        unk->state = sub_020501B8(unk, fieldSystem, HEAP_ID_FIELDMAP);
        break;
    case 1:
        unk->state = sub_02050290(unk, fieldSystem);
        break;
    case 2:
        unk->state = sub_020502E0(unk, fieldSystem, HEAP_ID_FIELDMAP);
        break;
    case 3:
