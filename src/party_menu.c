...
static u32 Pokemon_CountRibbonsByCategory(Pokemon *mon, u8 contestStat) {
    ...
    switch (contestStat) {
    case COOL:
        result = Pokemon_GetData(mon, MON_DATA_COOL_RIBBON, NULL);
        result += Pokemon_GetData(mon, MON_DATA_COOL_RIBBON_GREAT, NULL);
        result += Pokemon_GetData(mon, MON_DATA_COOL_RIBBON_ULTRA, NULL);
        result += Pokemon_GetData(mon, MON_DATA_COOL_RIBBON_MASTER, NULL);
        break;
    case BEAUTY:
        result = Pokemon_GetData(mon, MON_DATA_BEAUTY_RIBBON, NULL);
        result += Pokemon_GetData(mon, MON_DATA_BEAUTY_RIBBON_GREAT, NULL);
        result += Pokemon_GetData(mon, MON_DATA_BEAUTY_RIBBON_ULTRA, NULL);
        result += Pokemon_GetData(mon, MON_DATA_BEAUTY_RIBBON_MASTER, NULL);
        break;
    case CUTE:
        result = Pokemon_GetData(mon, MON_DATA_CUTE_RIBBON, NULL);
        result += Pokemon_GetData(mon, MON_DATA_CUTE_RIBBON_GREAT, NULL);
        result += Pokemon_GetData(mon, MON_DATA_CUTE_RIBBON_ULTRA, NULL);
        result += Pokemon_GetData(mon, MON_DATA_CUTE_RIBBON_MASTER, NULL);
        break;
    case SMART:
        result = Pokemon_GetData(mon, MON_DATA_SMART_RIBBON, NULL);
        result += Pokemon_GetData(mon, MON_DATA_SMART_RIBBON_GREAT, NULL);
        result += Pokemon_GetData(mon, MON_DATA_SMART_RIBBON_ULTRA, NULL);
        result += Pokemon_GetData(mon, MON_DATA_SMART_RIBBON_MASTER, NULL);
        break;
    case TOUGH:
        result = Pokemon_GetData(mon, MON_DATA_TOUGH_RIBBON, NULL);
        result += Pokemon_GetData(mon, MON_DATA_TOUGH_RIBBON_GREAT, NULL);
        result += Pokemon_GetData(mon, MON_DATA_TOUGH_RIBBON_ULTRA, NULL);
        result += Pokemon_GetData(mon, MON_DATA_TOUGH_RIBBON_MASTER, NULL);
        break;
    }
    return result;
}
