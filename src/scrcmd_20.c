...
static void sub_0204F1E4(TaskManager *taskManager, u16 playerSpecies, u16 *resultPtr) {
    UnkStruct_0204F1E4 *r4 = AllocFromHeap(HEAP_ID_FIELDMAP, sizeof(UnkStruct_0204F1E4));
...
static void sub_0204F284(TaskManager *taskManager, void *a1, BattleHallChallengeType challengeType) {
    ...
    UnkStruct_0204F284 *r4 = AllocFromHeap(HEAP_ID_FIELDMAP, sizeof(UnkStruct_0204F284));
...
static BOOL sub_0204F2B8(TaskManager *taskManager) {
    ...
    switch (r4->state) {
    case 0:
        r4->state = sub_0204F320(r4, fieldSystem, HEAP_ID_FIELDMAP);
        break;
    case 1:
        r4->state = sub_0204F3F8(r4, fieldSystem);
        break;
    case 2:
        r4->state = sub_0204F448(r4, fieldSystem, HEAP_ID_FIELDMAP);
        break;
    case 3:
