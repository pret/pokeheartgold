...
typedef struct UnkStruct_0204F284 {
    u32 state;
    u8 challengeType; // 0, 1, 2: singles, doubles, multi
    u8 unk05;
    u8 unk06[2];
    void **unk08;
} UnkStruct_0204F284;
...
static void sub_0204F284(TaskManager*, void*, u32);
...
BOOL ScrCmd_628(ScriptContext *ctx) {
    ...
    if (r4 == 3) {
        ...
        sub_02031108(
            sub_0203107C(ctx->fsys->savedata),
            r7,
            sub_0205C268(r7),
            0
        );
    ...
    sub_02031108(
        sub_0203107C(ctx->fsys->savedata),
        sub_0205BFF0(r5, r4),
        sub_0205C268(sub_0205BFF0(r5, r4)),
        0
    );
    sub_02031108(
        sub_0203107C(ctx->fsys->savedata),
        sub_0205C048(r5, r4),
        sub_0205C268(sub_0205C048(r5, r4)),
        0
    );
    return FALSE;
}
...
static BOOL BattleHall_DoesPartyContainEligibleMons(s32 numRequiredMons, SAVEDATA *savedata) {
    u8 i, numEligibleMons;
    u16 species, level, forme;
...
static void sub_0204F284(TaskManager *taskManager, void *a1, u32 challengeType) {
