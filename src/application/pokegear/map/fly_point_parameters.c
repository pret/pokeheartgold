...
const MapFlypointParam gMapFlypointParams[] = {
    ...
    { MAP_INDIGO_PLATEAU,   MAP_INDIGO_PLATEAU,                  FLYPOINT_INDIGO,       255,  28, 6,  0,  0,  1, 1, 0, 0, 0, 0 },
    ...
    { MAP_ECRUTEAK,         MAP_ECRUTEAK,                        FLYPOINT_CIANWOOD,     17,   11, 4,  5,  28, 2, 2, 4, 4, 1, 1 },
    ...
    { MAP_LAKE_OF_RAGE,     MAP_LAKE_OF_RAGE,                    FLYPOINT_LAKE_OF_RAGE, 255,  15, 1,  0,  0,  3, 2, 0, 0, 0, 0 },
    { MAP_MOUNT_SILVER,     MAP_MOUNT_SILVER,                    FLYPOINT_MT_SILVER,    255,  25, 8,  0,  0,  1, 1, 0, 0, 0, 0 },
    { MAP_SAFARI_ZONE_GATE, MAP_SAFARI_ZONE_GATE,                FLYPOINT_SAFARI,       255,  2,  8,  0,  0,  2, 2, 0, 0, 0, 0 },
    { MAP_BATTLE_FRONTIER,  MAP_BATTLE_FRONTIER_FRONTIER_ACCESS, FLYPOINT_UNION_CAVE,   255,  6,  6,  0,  0,  2, 2, 0, 0, 0, 0 },
    { MAP_NATIONAL_PARK,    MAP_POKEATHLON_DOME,                 FLYPOINT_POKEATHLON,   255,  10, 6,  0,  0,  2, 2, 0, 0, 0, 0 },
    { MAP_VICTORY_ROAD_1F,  MAP_ROUTE_26,                        FLYPOINT_VICTORY_ROAD, 255,  28, 7,  0,  0,  1, 2, 0, 0, 0, 0 },
};
