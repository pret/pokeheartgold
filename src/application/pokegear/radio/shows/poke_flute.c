...
void RadioShow_PokeFlute_InitGMM(RadioShow *radioShow);
void RadioShow_PokeFlute_UnloadGMM(RadioShow *radioShow);
...
BOOL RadioShow_PokeFlute_Setup(RadioShow *radioShow) {
    ...
    RadioShow_PokeFlute_InitGMM(radioShow);
...
BOOL RadioShow_PokeFlute_Teardown(RadioShow *radioShow) {
    RadioShow_PokeFlute_UnloadGMM(radioShow);
