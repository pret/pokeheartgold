...
static const u8 sCommercialsData[][3] = {
    { COMM_UNLOCK_ALWAYS,         3, 0xFF },
    { COMM_UNLOCK_ALWAYS,         3, 0xFF },
    { COMM_UNLOCK_ALWAYS,         3, 0xFF },
    { COMM_UNLOCK_ALWAYS,         3, 0xFF },
    { COMM_UNLOCK_ALWAYS,         3, 0xFF },
    { COMM_UNLOCK_ALWAYS,         1, 0xFF },
    { COMM_UNLOCK_ALWAYS,         1, 0xFF },
    { COMM_UNLOCK_ALWAYS,         1, 0xFF },
    { COMM_UNLOCK_ALWAYS,         1, 0xFF },
    { COMM_UNLOCK_ALWAYS,         3, 2    },
    { COMM_UNLOCK_ALWAYS,         3, 2    },
    { COMM_UNLOCK_POKEDEX,        3, 0xFF },
    { COMM_UNLOCK_POKEDEX,        3, 0xFF },
    { COMM_UNLOCK_POKEDEX,        3, 0xFF },
    { COMM_UNLOCK_POKEDEX,        3, 0xFF },
    { COMM_UNLOCK_ECRUTEAK,       1, 3    },
    { COMM_UNLOCK_ECRUTEAK,       1, 3    },
    { COMM_UNLOCK_ECRUTEAK,       1, 3    },
    { COMM_UNLOCK_ECRUTEAK,       1, 2    },
    { COMM_UNLOCK_ECRUTEAK,       1, 2    },
    { COMM_UNLOCK_ECRUTEAK,       3, 2    },
    { COMM_UNLOCK_CIANWOOD,       3, 2    },
    { COMM_UNLOCK_CIANWOOD,       1, 3    },
    { COMM_UNLOCK_OLIVINE,        3, 1    },
    { COMM_UNLOCK_OLIVINE,        3, 1    },
    { COMM_UNLOCK_OLIVINE,        3, 1    },
    { COMM_UNLOCK_OLIVINE,        3, 1    },
    { COMM_UNLOCK_OLIVINE,        3, 1    },
    { COMM_UNLOCK_OLIVINE,        3, 1    },
    { COMM_UNLOCK_GAME_CLEAR,     3, 3    },
    { COMM_UNLOCK_VERMILION,      2, 3    },
    { COMM_UNLOCK_VERMILION,      2, 3    },
    { COMM_UNLOCK_VERMILION,      2, 3    },
    { COMM_UNLOCK_VERMILION,      2, 3    },
    { COMM_UNLOCK_VERMILION,      2, 3    },
    { COMM_UNLOCK_RESTORED_POWER, 3, 3    },
};
