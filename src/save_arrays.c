...
DECL_CHUNK_EX(Save_TrainerHouse_sizeof, Save_TrainerHouse_init)
...
const struct SaveChunkHeader gSaveChunkHeaders[] = {
    ...
    {SAVE_POKEGEAR,      0, (SAVESIZEFN)SaveData_GSPlayerMisc_sizeof, (SAVEINITFN)SaveData_GSPlayerMisc_init },
    ...
    {SAVE_TRAINER_HOUSE, 0, (SAVESIZEFN)Save_TrainerHouse_sizeof,     (SAVEINITFN)Save_TrainerHouse_init },
