...
static void TouchSaveApp_SetupGraphics(TouchSaveAppData *data) {
    ...
    GfGfxLoader_GXLoadPal(NARC_a_0_1_4, 75, GF_PAL_LOCATION_SUB_BG, GF_PAL_SLOT_OFFSET_0, 0x200, HEAP_ID_8);
    LoadFontPal0(GF_PAL_LOCATION_SUB_BG, GF_PAL_SLOT_OFFSET_4, HEAP_ID_8);
