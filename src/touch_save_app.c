...
SysTask *ov30_0225D520(BgConfig *bgConfig, void *a1, FieldSystem *fieldSystem, void *a3) {
    ...
    BG_ClearCharDataRange(GF_BG_LYR_SUB_2, 0x20, 0, HEAP_ID_FIELD);
...
static void TouchSaveApp_SetupGraphics(TouchSaveAppData *data) {
    ...
    LoadUserFrameGfx2(data->bgConfig, GF_BG_LYR_SUB_1, 0xEC, 5, Options_GetFrame(data->options), HEAP_ID_FIELD);
}
...
static void ov30_0225D880(TouchSaveAppData *data) {
    ...
    YesNoPrompt *unk = YesNoPrompt_Create(HEAP_ID_FIELD);
...
static BOOL TouchSaveApp_DisplaySaveInformation(TouchSaveAppData *data) {
    UnkStruct_field_021F4360 *unk = ov01_021F4360(data->fieldSystem, HEAP_ID_FIELD, 5);
    data->unk40 = unk;
    ov01_021F42F8(unk);
