...
FieldSystem *FieldSystem_New(OverlayManager *man) {
    CreateHeap(HEAP_ID_3, HEAP_ID_FIELD2, 0x1C000);
    CreateHeap(HEAP_ID_3, HEAP_ID_FIELD3, 0x4000);
    ...
    fieldSystem->unk0 = AllocFromHeap(HEAP_ID_FIELD2, sizeof(struct FieldSystemUnkSub0));
...
void FieldSystem_Delete(OverlayManager *man) {
    ...
    DestroyHeap(HEAP_ID_FIELD2);
    DestroyHeap(HEAP_ID_FIELD3);
}
