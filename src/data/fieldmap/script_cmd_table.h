...
extern BOOL ScrCmd_430(SCRIPTCONTEXT *ctx);
extern BOOL ScrCmd_431(SCRIPTCONTEXT *ctx);
...
extern BOOL ScrCmd_668(SCRIPTCONTEXT *ctx);
...
extern BOOL ScrCmd_843(SCRIPTCONTEXT *ctx);
