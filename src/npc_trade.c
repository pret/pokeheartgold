...
static void _CreateTradeMon(Pokemon *mon, NPCTrade *trade_dat, u32 level, NpcTradeNum tradeno, u32 mapno, u32 met_level_strat, enum HeapID heapID) {
    ...
    Pokemon_InitWithParams(mon, trade_dat->give_species, level, 32, TRUE, trade_dat->pid, OT_ID_PRESET, trade_dat->otId);
    ...
    Pokemon_SetData(mon, MON_DATA_OT_GENDER, &trade_dat->gender);
